...
.method public postAndWait(Ljava/util/concurrent/Callable;I)Ljava/lang/Object;
    ...
    .line 175
    .local v3, "holder":Ljava/util/concurrent/atomic/AtomicReference;, "Ljava/util/concurrent/atomic/AtomicReference<TT;>;"
    ...
    .line 176
    .local v6, "running":Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .local v4, "callable":Ljava/util/concurrent/Callable;, "Ljava/util/concurrent/Callable<TT;>;"
    ...
    :goto_0
    :try_start_2
    invoke-interface {v7, v1, v2}, Ljava/util/concurrent/locks/Condition;->awaitNanos(J)J
    ...
    .end local v3    # "holder":Ljava/util/concurrent/atomic/AtomicReference;, "Ljava/util/concurrent/atomic/AtomicReference<TT;>;"
    .end local v4    # "callable":Ljava/util/concurrent/Callable;, "Ljava/util/concurrent/Callable<TT;>;"
    .end local v5    # "lock":Ljava/util/concurrent/locks/ReentrantLock;
    .end local v6    # "running":Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 214
    .end local v1    # "remaining":J
    .restart local v3    # "holder":Ljava/util/concurrent/atomic/AtomicReference;, "Ljava/util/concurrent/atomic/AtomicReference<TT;>;"
    .restart local v4    # "callable":Ljava/util/concurrent/Callable;, "Ljava/util/concurrent/Callable<TT;>;"
    .restart local v5    # "lock":Ljava/util/concurrent/locks/ReentrantLock;
    .restart local v6    # "running":Ljava/util/concurrent/atomic/AtomicBoolean;
