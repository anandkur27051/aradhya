...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.TooltipCompatHandler$$ExternalSyntheticLambda0
        ...
        public final void run() {
            TooltipCompatHandler.this.m161lambda$new$0$androidxappcompatwidgetTooltipCompatHandler();
        }
    };
    ...
    public /* synthetic */ void m161lambda$new$0$androidxappcompatwidgetTooltipCompatHandler() {
        show(false);
    }
