...
public class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0024R.styleable.AppCompatTextHelper, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this.mView, this.mView.getContext(), C0024R.styleable.AppCompatTextHelper, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        int ap = a.getResourceId(C0024R.styleable.AppCompatTextHelper_android_textAppearance, -1);
        if (a.hasValue(C0024R.styleable.AppCompatTextHelper_android_drawableLeft)) {
            this.mDrawableLeftTint = createTintInfo(context, drawableManager, a.getResourceId(C0024R.styleable.AppCompatTextHelper_android_drawableLeft, 0));
        }
        if (a.hasValue(C0024R.styleable.AppCompatTextHelper_android_drawableTop)) {
            this.mDrawableTopTint = createTintInfo(context, drawableManager, a.getResourceId(C0024R.styleable.AppCompatTextHelper_android_drawableTop, 0));
        }
        if (a.hasValue(C0024R.styleable.AppCompatTextHelper_android_drawableRight)) {
            this.mDrawableRightTint = createTintInfo(context, drawableManager, a.getResourceId(C0024R.styleable.AppCompatTextHelper_android_drawableRight, 0));
        }
        if (a.hasValue(C0024R.styleable.AppCompatTextHelper_android_drawableBottom)) {
            this.mDrawableBottomTint = createTintInfo(context, drawableManager, a.getResourceId(C0024R.styleable.AppCompatTextHelper_android_drawableBottom, 0));
        }
        if (a.hasValue(C0024R.styleable.AppCompatTextHelper_android_drawableStart)) {
            this.mDrawableStartTint = createTintInfo(context, drawableManager, a.getResourceId(C0024R.styleable.AppCompatTextHelper_android_drawableStart, 0));
        }
        if (a.hasValue(C0024R.styleable.AppCompatTextHelper_android_drawableEnd)) {
            this.mDrawableEndTint = createTintInfo(context, drawableManager, a.getResourceId(C0024R.styleable.AppCompatTextHelper_android_drawableEnd, 0));
        }
        a.recycle();
        ...
        if (ap != -1) {
            TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(context, ap, C0024R.styleable.TextAppearance);
            if (!hasPwdTm && a2.hasValue(C0024R.styleable.TextAppearance_textAllCaps)) {
                allCapsSet2 = true;
                allCaps2 = a2.getBoolean(C0024R.styleable.TextAppearance_textAllCaps, false);
            }
            updateTypefaceAndStyle(context, a2);
            if (a2.hasValue(C0024R.styleable.TextAppearance_textLocale)) {
                localeListString = a2.getString(C0024R.styleable.TextAppearance_textLocale);
            }
            if (a2.hasValue(C0024R.styleable.TextAppearance_fontVariationSettings)) {
                fontVariation2 = a2.getString(C0024R.styleable.TextAppearance_fontVariationSettings);
            }
            a2.recycle();
        }
        TintTypedArray a3 = TintTypedArray.obtainStyledAttributes(context, attrs, C0024R.styleable.TextAppearance, defStyleAttr, 0);
        if (!hasPwdTm && a3.hasValue(C0024R.styleable.TextAppearance_textAllCaps)) {
            allCaps = a3.getBoolean(C0024R.styleable.TextAppearance_textAllCaps, false);
            allCapsSet = true;
        } else {
            allCaps = allCaps2;
            allCapsSet = allCapsSet2;
        }
        if (a3.hasValue(C0024R.styleable.TextAppearance_textLocale)) {
            localeListString = a3.getString(C0024R.styleable.TextAppearance_textLocale);
        }
        if (a3.hasValue(C0024R.styleable.TextAppearance_fontVariationSettings)) {
            fontVariation = a3.getString(C0024R.styleable.TextAppearance_fontVariationSettings);
        } else {
            fontVariation = fontVariation2;
        }
        if (a3.hasValue(C0024R.styleable.TextAppearance_android_textSize) && a3.getDimensionPixelSize(C0024R.styleable.TextAppearance_android_textSize, -1) == 0) {
        ...
        TintTypedArray a4 = TintTypedArray.obtainStyledAttributes(context, attrs, C0024R.styleable.AppCompatTextView);
        Drawable drawableBottom = null;
        Drawable drawableLeft = null;
        Drawable drawableTop = null;
        int drawableLeftId = a4.getResourceId(C0024R.styleable.AppCompatTextView_drawableLeftCompat, -1);
        if (drawableLeftId != -1) {
            drawableLeft = drawableManager.getDrawable(context, drawableLeftId);
        }
        int drawableTopId = a4.getResourceId(C0024R.styleable.AppCompatTextView_drawableTopCompat, -1);
        if (drawableTopId != -1) {
            drawableTop = drawableManager.getDrawable(context, drawableTopId);
        }
        int drawableRightId = a4.getResourceId(C0024R.styleable.AppCompatTextView_drawableRightCompat, -1);
        Drawable drawableRight = drawableRightId != -1 ? drawableManager.getDrawable(context, drawableRightId) : null;
        int drawableBottomId = a4.getResourceId(C0024R.styleable.AppCompatTextView_drawableBottomCompat, -1);
        if (drawableBottomId != -1) {
            drawableBottom = drawableManager.getDrawable(context, drawableBottomId);
        }
        int drawableStartId = a4.getResourceId(C0024R.styleable.AppCompatTextView_drawableStartCompat, -1);
        Drawable drawableStart = drawableStartId != -1 ? drawableManager.getDrawable(context, drawableStartId) : null;
        int drawableEndId = a4.getResourceId(C0024R.styleable.AppCompatTextView_drawableEndCompat, -1);
        ...
        if (a4.hasValue(C0024R.styleable.AppCompatTextView_drawableTint)) {
            ColorStateList tintList = a4.getColorStateList(C0024R.styleable.AppCompatTextView_drawableTint);
            TextViewCompat.setCompoundDrawableTintList(this.mView, tintList);
        }
        if (a4.hasValue(C0024R.styleable.AppCompatTextView_drawableTintMode)) {
            PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(a4.getInt(C0024R.styleable.AppCompatTextView_drawableTintMode, -1), null);
            TextViewCompat.setCompoundDrawableTintMode(this.mView, tintMode);
        }
        int firstBaselineToTopHeight = a4.getDimensionPixelSize(C0024R.styleable.AppCompatTextView_firstBaselineToTopHeight, -1);
        int lastBaselineToBottomHeight = a4.getDimensionPixelSize(C0024R.styleable.AppCompatTextView_lastBaselineToBottomHeight, -1);
        int lineHeight = a4.getDimensionPixelSize(C0024R.styleable.AppCompatTextView_lineHeight, -1);
        a4.recycle();
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        this.mStyle = a.getInt(C0024R.styleable.TextAppearance_android_textStyle, this.mStyle);
        this.mFontWeight = a.getInt(C0024R.styleable.TextAppearance_android_textFontWeight, -1);
        if (this.mFontWeight != -1) {
            this.mStyle = (this.mStyle & 2) | 0;
        }
        if (a.hasValue(C0024R.styleable.TextAppearance_android_fontFamily) || a.hasValue(C0024R.styleable.TextAppearance_fontFamily)) {
            this.mFontTypeface = null;
            if (a.hasValue(C0024R.styleable.TextAppearance_fontFamily)) {
                fontFamilyId = C0024R.styleable.TextAppearance_fontFamily;
            } else {
                fontFamilyId = C0024R.styleable.TextAppearance_android_fontFamily;
            }
            ...
            if (!context.isRestricted()) {
                ...
                ResourcesCompat.FontCallback replyCallback = new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                    ...
                    public void m7xb24343b7(int reason) {
                    }
                };
                try {
        ...
        if (a.hasValue(C0024R.styleable.TextAppearance_android_typeface)) {
            this.mAsyncFontPending = false;
            int typefaceIndex = a.getInt(C0024R.styleable.TextAppearance_android_typeface, 1);
    ...
    public void onSetTextAppearance(Context context, int resId) {
        String fontVariation;
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, resId, C0024R.styleable.TextAppearance);
        if (a.hasValue(C0024R.styleable.TextAppearance_textAllCaps)) {
            setAllCaps(a.getBoolean(C0024R.styleable.TextAppearance_textAllCaps, false));
        }
        if (a.hasValue(C0024R.styleable.TextAppearance_android_textSize) && a.getDimensionPixelSize(C0024R.styleable.TextAppearance_android_textSize, -1) == 0) {
            this.mView.setTextSize(0, 0.0f);
        }
        updateTypefaceAndStyle(context, a);
        if (a.hasValue(C0024R.styleable.TextAppearance_fontVariationSettings) && (fontVariation = a.getString(C0024R.styleable.TextAppearance_fontVariationSettings)) != null) {
            Api26Impl.setFontVariationSettings(this.mView, fontVariation);
        }
        a.recycle();
        if (this.mFontTypeface != null) {
