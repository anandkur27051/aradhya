...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0024R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0024R.styleable.LinearLayoutCompat, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        int index = a.getInt(C0024R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        int index2 = a.getInt(C0024R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index2 >= 0) {
            setGravity(index2);
        }
        boolean baselineAligned = a.getBoolean(C0024R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C0024R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C0024R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C0024R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C0024R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C0024R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0024R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
            ...
            if (child2 == null) {
                ...
                if (allFillParent3) {
                    ...
                    if (lp.width == -1) {
                        allFillParent2 = true;
                        if (lp.weight <= 0.0f) {
                            heightMode4 = Math.max(heightMode4, matchWidthLocally ? margin3 : measuredWidth);
                            largestChildHeight3 = alternativeMaxWidth3;
                        } else {
                            int i3 = matchWidthLocally ? margin3 : measuredWidth;
                    ...
                    while (i7 < count) {
                        ...
                        if (child4 != null) {
                            ...
                            if (child4.getVisibility() == 8) {
                                ...
                                child4.measure(makeMeasureSpec, weightedMaxWidth4);
                            } else {
                                weightedMaxWidth = weightedMaxWidth3;
                            }
                        } else {
        ...
        while (measuredWidth3 < count) {
            ...
            if (child5.getVisibility() == 8) {
                ...
                if (childExtra <= 0.0f) {
                    ...
                    int heightMode8 = child5.getMeasuredHeight();
                    int childHeight2 = heightMode8 + share;
                    if (childHeight2 < 0) {
                        childHeight2 = 0;
                    }
                    baselineChildIndex = baselineChildIndex2;
                ...
                int margin4 = heightMode9 + lp4.rightMargin;
                int measuredWidth4 = child5.getMeasuredWidth() + margin4;
                maxWidth = Math.max(maxWidth, measuredWidth4);
                if (widthMode != 1073741824) {
                    margin = margin4;
                    if (lp4.width == -1) {
                        margin2 = 1;
                        int alternativeMaxWidth5 = Math.max(largestChildHeight3, margin2 == 0 ? margin : measuredWidth4);
                        if (allFillParent3 && lp4.width == -1) {
                            allFillParent = true;
                ...
                margin2 = 0;
                int alternativeMaxWidth52 = Math.max(largestChildHeight3, margin2 == 0 ? margin : measuredWidth4);
                if (allFillParent3) {
                    allFillParent = true;
