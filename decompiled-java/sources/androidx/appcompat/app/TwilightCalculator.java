...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        float n = (float) Math.round((daysSince2000 - f14J0) - arcLongitude);
        double solarTransitJ2000 = f14J0 + n + arcLongitude + (Math.sin(meanAnomaly) * 0.0053d) + (Math.sin(2.0d * solarLng) * (-0.0069d));
        ...
        if (cosHourAngle >= 1.0d) {
            ...
            this.sunset = Math.round((solarTransitJ2000 + hourAngle) * 8.64E7d) + UTC_2000;
