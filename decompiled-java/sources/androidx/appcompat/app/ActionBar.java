...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = 0;
            TypedArray a = c.obtainStyledAttributes(attrs, C0024R.styleable.ActionBarLayout);
            this.gravity = a.getInt(C0024R.styleable.ActionBarLayout_android_layout_gravity, 0);
            a.recycle();
        }
