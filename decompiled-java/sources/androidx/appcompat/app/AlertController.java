...
public class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0024R.attr.alertDialogCenterButtons, outValue, true);
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0024R.styleable.AlertDialog, C0024R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0024R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0024R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0024R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0024R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0024R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0024R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0024R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0024R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:59:0x00a1, code lost:
        ...
        r1 = r9.findViewById(androidx.appcompat.C0024R.id.titleDividerNoCustom);
     */
    /*
    ...
    */
    private void setupView() {
        int i;
        View spacer;
        View parentPanel = this.mWindow.findViewById(C0024R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0024R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0024R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0024R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0024R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0024R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0024R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0024R.id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null && (spacer = contentPanel.findViewById(C0024R.id.textSpacerNoButtons)) != null) {
            spacer.setVisibility(0);
        }
        if (contentPanel == null) {
            i = 0;
        } else {
            View spacer2 = contentPanel.findViewById(C0024R.id.textSpacerNoTitle);
            if (spacer2 == null) {
                i = 0;
            } else {
                i = 0;
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0024R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0024R.id.scrollIndicatorDown);
    ...
    /* loaded from: classes.dex */
    class C00272 implements NestedScrollView.OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C00272(View view, View view2) {
            this.val$top = view;
    ...
    class RunnableC00283 implements Runnable {
        ...
        RunnableC00283(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    /* loaded from: classes.dex */
    class C00294 implements AbsListView.OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C00294(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    /* loaded from: classes.dex */
    class RunnableC00305 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        RunnableC00305(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0024R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0024R.id.title_template);
        ...
        if (hasTextTitle && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0024R.id.alertTitle);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0024R.id.title_template);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0024R.id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0024R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0024R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0024R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
