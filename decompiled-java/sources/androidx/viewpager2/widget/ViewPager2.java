...
import androidx.viewpager2.C0463R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0463R.styleable.ViewPager2);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0463R.styleable.ViewPager2, attrs, a, 0, 0);
        }
        try {
            setOrientation(a.getInt(C0463R.styleable.ViewPager2_android_orientation, 0));
        } finally {
            a.recycle();
        }
    }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        void updatePageAccessibilityActions() {
            ...
            int actionIdPageBackward = R.id.accessibilityActionPageLeft;
            ViewCompat.removeAccessibilityAction(viewPager, R.id.accessibilityActionPageLeft);
            ViewCompat.removeAccessibilityAction(viewPager, R.id.accessibilityActionPageRight);
            ViewCompat.removeAccessibilityAction(viewPager, R.id.accessibilityActionPageUp);
            ViewCompat.removeAccessibilityAction(viewPager, R.id.accessibilityActionPageDown);
            ...
            if (viewPager2.mCurrentItem < itemCount - 1) {
                ViewCompat.replaceAccessibilityAction(viewPager, new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.accessibilityActionPageDown, null), null, this.mActionPageForward);
            }
            if (ViewPager2.this.mCurrentItem > 0) {
                ViewCompat.replaceAccessibilityAction(viewPager, new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.accessibilityActionPageUp, null), null, this.mActionPageBackward);
            }
        }
