...
import androidx.cardview.C0113R;
...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attrs) {
        this(context, attrs, C0113R.attr.cardViewStyle);
    }
    ...
    public CardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0113R.styleable.CardView, defStyleAttr, C0113R.style.CardView);
        if (a.hasValue(C0113R.styleable.CardView_cardBackgroundColor)) {
            backgroundColor = a.getColorStateList(C0113R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (hsv[2] > 0.5f) {
                color = getResources().getColor(C0113R.color.cardview_light_background);
            } else {
                color = getResources().getColor(C0113R.color.cardview_dark_background);
            }
        ...
        float maxElevation2 = a.getDimension(C0113R.styleable.CardView_cardMaxElevation, 0.0f);
        ...
        this.mUserSetMinWidth = a.getDimensionPixelSize(C0113R.styleable.CardView_android_minWidth, 0);
        this.mUserSetMinHeight = a.getDimensionPixelSize(C0113R.styleable.CardView_android_minHeight, 0);
        a.recycle();
