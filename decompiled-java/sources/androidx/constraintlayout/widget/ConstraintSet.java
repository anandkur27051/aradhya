...
import androidx.constraintlayout.widget.C0148R;
...
public class ConstraintSet {
    ...
    static {
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintLeft_toRightOf, 26);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintRight_toLeftOf, 29);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintRight_toRightOf, 30);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintTop_toTopOf, 36);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintTop_toBottomOf, 35);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintBottom_toTopOf, 4);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintBottom_toBottomOf, 3);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintBaseline_toBaselineOf, 1);
        mapToConstant.append(C0148R.styleable.Constraint_layout_editor_absoluteX, 6);
        mapToConstant.append(C0148R.styleable.Constraint_layout_editor_absoluteY, 7);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintGuide_begin, 17);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintGuide_end, 18);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintGuide_percent, 19);
        mapToConstant.append(C0148R.styleable.Constraint_android_orientation, 27);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintStart_toEndOf, 32);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintStart_toStartOf, 33);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintEnd_toStartOf, 10);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintEnd_toEndOf, 9);
        mapToConstant.append(C0148R.styleable.Constraint_layout_goneMarginLeft, 13);
        mapToConstant.append(C0148R.styleable.Constraint_layout_goneMarginTop, 16);
        mapToConstant.append(C0148R.styleable.Constraint_layout_goneMarginRight, 14);
        mapToConstant.append(C0148R.styleable.Constraint_layout_goneMarginBottom, 11);
        mapToConstant.append(C0148R.styleable.Constraint_layout_goneMarginStart, 15);
        mapToConstant.append(C0148R.styleable.Constraint_layout_goneMarginEnd, 12);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintVertical_weight, 40);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintHorizontal_weight, 39);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintHorizontal_chainStyle, 41);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintVertical_chainStyle, 42);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintHorizontal_bias, 20);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintVertical_bias, 37);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintDimensionRatio, 5);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintLeft_creator, UNUSED);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintTop_creator, UNUSED);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintRight_creator, UNUSED);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintBottom_creator, UNUSED);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintBaseline_creator, UNUSED);
        mapToConstant.append(C0148R.styleable.Constraint_android_layout_marginLeft, 24);
        mapToConstant.append(C0148R.styleable.Constraint_android_layout_marginRight, 28);
        mapToConstant.append(C0148R.styleable.Constraint_android_layout_marginStart, 31);
        mapToConstant.append(C0148R.styleable.Constraint_android_layout_marginEnd, 8);
        mapToConstant.append(C0148R.styleable.Constraint_android_layout_marginTop, 34);
        mapToConstant.append(C0148R.styleable.Constraint_android_layout_marginBottom, 2);
        mapToConstant.append(C0148R.styleable.Constraint_android_layout_width, 23);
        mapToConstant.append(C0148R.styleable.Constraint_android_layout_height, 21);
        mapToConstant.append(C0148R.styleable.Constraint_android_visibility, 22);
        mapToConstant.append(C0148R.styleable.Constraint_android_alpha, 43);
        mapToConstant.append(C0148R.styleable.Constraint_android_elevation, 44);
        mapToConstant.append(C0148R.styleable.Constraint_android_rotationX, 45);
        mapToConstant.append(C0148R.styleable.Constraint_android_rotationY, 46);
        mapToConstant.append(C0148R.styleable.Constraint_android_rotation, 60);
        mapToConstant.append(C0148R.styleable.Constraint_android_scaleX, 47);
        mapToConstant.append(C0148R.styleable.Constraint_android_scaleY, 48);
        mapToConstant.append(C0148R.styleable.Constraint_android_transformPivotX, 49);
        mapToConstant.append(C0148R.styleable.Constraint_android_transformPivotY, 50);
        mapToConstant.append(C0148R.styleable.Constraint_android_translationX, 51);
        mapToConstant.append(C0148R.styleable.Constraint_android_translationY, TRANSLATION_Y);
        mapToConstant.append(C0148R.styleable.Constraint_android_translationZ, TRANSLATION_Z);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintWidth_default, WIDTH_DEFAULT);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintHeight_default, HEIGHT_DEFAULT);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintWidth_max, WIDTH_MAX);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintHeight_max, HEIGHT_MAX);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintWidth_min, WIDTH_MIN);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintHeight_min, HEIGHT_MIN);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintCircle, 61);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintCircleRadius, CIRCLE_RADIUS);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0148R.styleable.Constraint_animate_relativeTo, 64);
        mapToConstant.append(C0148R.styleable.Constraint_transitionEasing, TRANSITION_EASING);
        mapToConstant.append(C0148R.styleable.Constraint_drawPath, DRAW_PATH);
        mapToConstant.append(C0148R.styleable.Constraint_transitionPathRotate, TRANSITION_PATH_ROTATE);
        mapToConstant.append(C0148R.styleable.Constraint_motionStagger, MOTION_STAGGER);
        mapToConstant.append(C0148R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C0148R.styleable.Constraint_motionProgress, PROGRESS);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintWidth_percent, WIDTH_PERCENT);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintHeight_percent, HEIGHT_PERCENT);
        mapToConstant.append(C0148R.styleable.Constraint_chainUseRtl, CHAIN_USE_RTL);
        mapToConstant.append(C0148R.styleable.Constraint_barrierDirection, BARRIER_DIRECTION);
        mapToConstant.append(C0148R.styleable.Constraint_barrierMargin, BARRIER_MARGIN);
        mapToConstant.append(C0148R.styleable.Constraint_constraint_referenced_ids, CONSTRAINT_REFERENCED_IDS);
        mapToConstant.append(C0148R.styleable.Constraint_barrierAllowsGoneWidgets, BARRIER_ALLOWS_GONE_WIDGETS);
        mapToConstant.append(C0148R.styleable.Constraint_pathMotionArc, PATH_MOTION_ARC);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constraintTag, CONSTRAINT_TAG);
        mapToConstant.append(C0148R.styleable.Constraint_visibilityMode, VISIBILITY_MODE);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constrainedWidth, CONSTRAINED_WIDTH);
        mapToConstant.append(C0148R.styleable.Constraint_layout_constrainedHeight, CONSTRAINED_HEIGHT);
    }
    ...
    public static class Layout {
        ...
        static {
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintLeft_toLeftOf, 24);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintLeft_toRightOf, 25);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintRight_toLeftOf, 28);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintRight_toRightOf, 29);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintTop_toTopOf, 35);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintTop_toBottomOf, 34);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintBottom_toTopOf, 4);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintBottom_toBottomOf, 3);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintBaseline_toBaselineOf, 1);
            mapToConstant.append(C0148R.styleable.Layout_layout_editor_absoluteX, 6);
            mapToConstant.append(C0148R.styleable.Layout_layout_editor_absoluteY, 7);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintGuide_begin, 17);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintGuide_end, 18);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintGuide_percent, 19);
            mapToConstant.append(C0148R.styleable.Layout_android_orientation, 26);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintStart_toEndOf, 31);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintStart_toStartOf, 32);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintEnd_toStartOf, 10);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintEnd_toEndOf, 9);
            mapToConstant.append(C0148R.styleable.Layout_layout_goneMarginLeft, 13);
            mapToConstant.append(C0148R.styleable.Layout_layout_goneMarginTop, 16);
            mapToConstant.append(C0148R.styleable.Layout_layout_goneMarginRight, 14);
            mapToConstant.append(C0148R.styleable.Layout_layout_goneMarginBottom, 11);
            mapToConstant.append(C0148R.styleable.Layout_layout_goneMarginStart, 15);
            mapToConstant.append(C0148R.styleable.Layout_layout_goneMarginEnd, 12);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintVertical_weight, 38);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintHorizontal_weight, 37);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintHorizontal_chainStyle, 39);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintVertical_chainStyle, 40);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintHorizontal_bias, 20);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintVertical_bias, 36);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintDimensionRatio, 5);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintLeft_creator, UNUSED);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintTop_creator, UNUSED);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintRight_creator, UNUSED);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintBottom_creator, UNUSED);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintBaseline_creator, UNUSED);
            mapToConstant.append(C0148R.styleable.Layout_android_layout_marginLeft, 23);
            mapToConstant.append(C0148R.styleable.Layout_android_layout_marginRight, 27);
            mapToConstant.append(C0148R.styleable.Layout_android_layout_marginStart, 30);
            mapToConstant.append(C0148R.styleable.Layout_android_layout_marginEnd, 8);
            mapToConstant.append(C0148R.styleable.Layout_android_layout_marginTop, 33);
            mapToConstant.append(C0148R.styleable.Layout_android_layout_marginBottom, 2);
            mapToConstant.append(C0148R.styleable.Layout_android_layout_width, 22);
            mapToConstant.append(C0148R.styleable.Layout_android_layout_height, 21);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintCircle, 61);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintCircleRadius, CIRCLE_RADIUS);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintCircleAngle, 63);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintWidth_percent, WIDTH_PERCENT);
            mapToConstant.append(C0148R.styleable.Layout_layout_constraintHeight_percent, HEIGHT_PERCENT);
            mapToConstant.append(C0148R.styleable.Layout_chainUseRtl, CHAIN_USE_RTL);
            mapToConstant.append(C0148R.styleable.Layout_barrierDirection, BARRIER_DIRECTION);
            mapToConstant.append(C0148R.styleable.Layout_barrierMargin, BARRIER_MARGIN);
            mapToConstant.append(C0148R.styleable.Layout_constraint_referenced_ids, CONSTRAINT_REFERENCED_IDS);
            mapToConstant.append(C0148R.styleable.Layout_barrierAllowsGoneWidgets, BARRIER_ALLOWS_GONE_WIDGETS);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0148R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        static {
            mapToConstant.append(C0148R.styleable.Transform_android_rotation, 1);
            mapToConstant.append(C0148R.styleable.Transform_android_rotationX, 2);
            mapToConstant.append(C0148R.styleable.Transform_android_rotationY, 3);
            mapToConstant.append(C0148R.styleable.Transform_android_scaleX, 4);
            mapToConstant.append(C0148R.styleable.Transform_android_scaleY, 5);
            mapToConstant.append(C0148R.styleable.Transform_android_transformPivotX, 6);
            mapToConstant.append(C0148R.styleable.Transform_android_transformPivotY, 7);
            mapToConstant.append(C0148R.styleable.Transform_android_translationX, 8);
            mapToConstant.append(C0148R.styleable.Transform_android_translationY, 9);
            mapToConstant.append(C0148R.styleable.Transform_android_translationZ, 10);
            mapToConstant.append(C0148R.styleable.Transform_android_elevation, 11);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0148R.styleable.Transform);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
    ...
    public static class PropertySet {
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0148R.styleable.PropertySet);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0148R.styleable.PropertySet_android_alpha) {
                    this.alpha = a.getFloat(attr, this.alpha);
                } else if (attr == C0148R.styleable.PropertySet_android_visibility) {
                    this.visibility = a.getInt(attr, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (attr == C0148R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = a.getInt(attr, this.mVisibilityMode);
                } else if (attr == C0148R.styleable.PropertySet_motionProgress) {
    ...
    public static class Motion {
        ...
        static {
            mapToConstant.append(C0148R.styleable.Motion_motionPathRotate, 1);
            mapToConstant.append(C0148R.styleable.Motion_pathMotionArc, 2);
            mapToConstant.append(C0148R.styleable.Motion_transitionEasing, 3);
            mapToConstant.append(C0148R.styleable.Motion_drawPath, 4);
            mapToConstant.append(C0148R.styleable.Motion_animate_relativeTo, 5);
            mapToConstant.append(C0148R.styleable.Motion_motionStagger, 6);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0148R.styleable.Motion);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer key : set.mConstraints.keySet()) {
            this.mConstraints.put(key, set.mConstraints.get(key).m164clone());
        }
    }
    ...
    */
    public void applyToInternal(ConstraintLayout constraintLayout, boolean applyPostLayout) {
            ...
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                ...
                if (id != -1) {
                    if (this.mConstraints.containsKey(Integer.valueOf(id))) {
                        ...
                        ConstraintLayout.LayoutParams param2 = (ConstraintLayout.LayoutParams) view.getLayoutParams();
                        param2.validate();
                        constraint.applyTo(param2);
                        if (applyPostLayout) {
                        }
        ...
        while (it.hasNext()) {
            ...
            if (constraint2.layout.mHelperType != -1) {
                switch (constraint2.layout.mHelperType) {
                    case 1:
                        ...
                        constraintLayout.addView(barrier2, param3);
                        break;
                }
            }
            if (constraint2.layout.mIsGuideline) {
                ...
                ConstraintLayout.LayoutParams param4 = constraintLayout.generateDefaultLayoutParams();
                constraint2.applyTo(param4);
                constraintLayout.addView(g, param4);
            }
        }
    }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0148R.styleable.Constraint);
    ...
    private void populateConstraint(Context ctx, Constraint c, TypedArray a) {
        ...
        for (int i = 0; i < N; i++) {
            int attr = a.getIndex(i);
            if (attr != C0148R.styleable.Constraint_android_id && C0148R.styleable.Constraint_android_layout_marginStart != attr && C0148R.styleable.Constraint_android_layout_marginEnd != attr) {
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i < split.length) {
            ...
            int tag = 0;
            try {
                Field field = C0148R.id.class.getField(idString);
