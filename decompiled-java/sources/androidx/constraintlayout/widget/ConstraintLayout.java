...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        */
        public final void measure(ConstraintWidget widget, BasicMeasure.Measure measure) {
            ...
            boolean useCurrent;
            boolean shouldDoWrap2;
            boolean useCurrent2;
            boolean horizontalDimensionKnown;
            boolean horizontalUseRatio;
            boolean horizontalUseRatio2;
            boolean verticalUseRatio;
            boolean verticalUseRatio2;
            LayoutParams params;
            int w;
            int h;
            int width;
            ...
            switch (horizontalBehavior) {
                case FIXED:
                    horizontalSpec = View.MeasureSpec.makeMeasureSpec(horizontalDimension, BasicMeasure.EXACTLY);
                    widget.wrapMeasure[2] = horizontalDimension;
                    break;
                case WRAP_CONTENT:
                    int horizontalSpec2 = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, widthPadding, -2);
                    didHorizontalWrap = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                    widget.wrapMeasure[2] = -2;
                    horizontalSpec = horizontalSpec2;
                    break;
                case MATCH_PARENT:
                    int horizontalSpec3 = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, widget.getHorizontalMargin() + widthPadding, -1);
                    widget.wrapMeasure[2] = -1;
                    horizontalSpec = horizontalSpec3;
                    break;
                case MATCH_CONSTRAINT:
                    horizontalSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, widthPadding, -2);
                    didHorizontalWrap = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                    boolean shouldDoWrap3 = widget.mMatchConstraintDefaultWidth == 1 ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
                    widget.wrapMeasure[2] = 0;
                    if (!measure.useCurrentDimensions) {
                        break;
                    } else {
                        if (!shouldDoWrap3 || widget.wrapMeasure[3] == 0) {
                            shouldDoWrap = shouldDoWrap3;
                        } else {
                            shouldDoWrap = shouldDoWrap3;
                            break;
                        }
                        if (!(child instanceof Placeholder)) {
                            ...
                            if (shouldDoWrap || useCurrent) {
                                horizontalSpec = View.MeasureSpec.makeMeasureSpec(widget.getWidth(), BasicMeasure.EXACTLY);
            ...
            switch (verticalBehavior) {
                case FIXED:
                    verticalSpec = View.MeasureSpec.makeMeasureSpec(verticalDimension, BasicMeasure.EXACTLY);
                    widget.wrapMeasure[3] = verticalDimension;
                    break;
                case WRAP_CONTENT:
                    verticalSpec = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, heightPadding, -2);
                    didVerticalWrap = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                    widget.wrapMeasure[3] = -2;
                    break;
                case MATCH_PARENT:
                    verticalSpec = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, widget.getVerticalMargin() + heightPadding, -1);
                    widget.wrapMeasure[3] = -1;
                    break;
                case MATCH_CONSTRAINT:
                    verticalSpec = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, heightPadding, -2);
                    didVerticalWrap = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                    boolean shouldDoWrap4 = widget.mMatchConstraintDefaultHeight == 1 ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
                    widget.wrapMeasure[3] = 0;
                    if (measure.useCurrentDimensions) {
                        if (!shouldDoWrap4 || widget.wrapMeasure[2] == 0) {
                            shouldDoWrap2 = shouldDoWrap4;
                        } else {
                            shouldDoWrap2 = shouldDoWrap4;
                            break;
                        }
                        if (!(child instanceof Placeholder)) {
                            ...
                            if (shouldDoWrap2 || useCurrent2) {
                                verticalSpec = View.MeasureSpec.makeMeasureSpec(widget.getHeight(), BasicMeasure.EXACTLY);
            ...
            boolean horizontalDimensionKnown2 = (horizontalBehavior == ConstraintWidget.DimensionBehaviour.MATCH_PARENT || horizontalBehavior == ConstraintWidget.DimensionBehaviour.FIXED) ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
            if (horizontalMatchConstraints) {
                horizontalDimensionKnown = horizontalDimensionKnown2;
                if (widget.mDimensionRatio > 0.0f) {
                    horizontalUseRatio = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                    if (verticalMatchConstraints) {
                        horizontalUseRatio2 = horizontalUseRatio;
                    } else {
                        horizontalUseRatio2 = horizontalUseRatio;
                        if (widget.mDimensionRatio > 0.0f) {
                            verticalUseRatio = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                            verticalUseRatio2 = verticalUseRatio;
                            ...
                            if (measure.useCurrentDimensions && horizontalMatchConstraints && widget.mMatchConstraintDefaultWidth == 0 && verticalMatchConstraints && widget.mMatchConstraintDefaultHeight == 0) {
                                ...
                                if (!horizontalUseRatio2 && verticalDimensionKnown) {
                                    float ratio = widget.mDimensionRatio;
                                    float ratio2 = height;
                                    int width3 = (int) ((ratio2 * ratio) + 0.5f);
                                    width = width3;
                                } else if (verticalUseRatio2 && horizontalDimensionKnown) {
                                    float ratio3 = widget.mDimensionRatio;
                                    height = (int) ((width / ratio3) + 0.5f);
                                }
                                if (w == width || h != height) {
                                    if (w == width) {
                                    ...
                                    if (h != height) {
                                        verticalSpec = View.MeasureSpec.makeMeasureSpec(height, i);
                                    }
                                    child.measure(horizontalSpec, verticalSpec);
                            ...
                            hasBaseline = w2 != -1 ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
                            measure.measuredNeedsSolverPass = (width == measure.horizontalDimension || height2 != measure.verticalDimension) ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
                            if (params.needsBaseline) {
                                hasBaseline = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                            }
                            if (hasBaseline && w2 != -1 && widget.getBaselineDistance() != w2) {
                    ...
                    if (!horizontalUseRatio2) {
                    }
                    if (verticalUseRatio2) {
                        float ratio32 = widget.mDimensionRatio;
                        height = (int) ((width / ratio32) + 0.5f);
                    }
                    if (w == width) {
                    }
                    if (w == width) {
                    ...
                    child.measure(horizontalSpec, verticalSpec);
                    int width42 = child.getMeasuredWidth();
                    height2 = child.getMeasuredHeight();
            ...
            child.measure(horizontalSpec, verticalSpec);
            int width422 = child.getMeasuredWidth();
            height2 = child.getMeasuredHeight();
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mConstraintSet = null;
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, C0148R.styleable.ConstraintLayout_Layout, defStyleAttr, defStyleRes);
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0148R.styleable.ConstraintLayout_Layout_android_minWidth) {
                    this.mMinWidth = a.getDimensionPixelOffset(attr, this.mMinWidth);
                } else if (attr == C0148R.styleable.ConstraintLayout_Layout_android_minHeight) {
                    this.mMinHeight = a.getDimensionPixelOffset(attr, this.mMinHeight);
                } else if (attr == C0148R.styleable.ConstraintLayout_Layout_android_maxWidth) {
                    this.mMaxWidth = a.getDimensionPixelOffset(attr, this.mMaxWidth);
                } else if (attr == C0148R.styleable.ConstraintLayout_Layout_android_maxHeight) {
                    this.mMaxHeight = a.getDimensionPixelOffset(attr, this.mMaxHeight);
                } else if (attr == C0148R.styleable.ConstraintLayout_Layout_layout_optimizationLevel) {
                    this.mOptimizationLevel = a.getInt(attr, this.mOptimizationLevel);
                } else if (attr == C0148R.styleable.ConstraintLayout_Layout_layoutDescription) {
                ...
                } else if (attr == C0148R.styleable.ConstraintLayout_Layout_constraintSet) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private static class Table {
            ...
            static {
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf, 8);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toRightOf, 9);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintRight_toLeftOf, 10);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintRight_toRightOf, 11);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintTop_toTopOf, 12);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintTop_toBottomOf, 13);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toTopOf, 14);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toBottomOf, 15);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_toBaselineOf, 16);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintCircle, 2);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintCircleRadius, 3);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintCircleAngle, 4);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_editor_absoluteX, 49);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_editor_absoluteY, 50);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintGuide_begin, 5);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintGuide_end, 6);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintGuide_percent, 7);
                map.append(C0148R.styleable.ConstraintLayout_Layout_android_orientation, 1);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintStart_toEndOf, 17);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintStart_toStartOf, 18);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toStartOf, 19);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toEndOf, 20);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_goneMarginLeft, 21);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_goneMarginTop, 22);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_goneMarginRight, 23);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_goneMarginBottom, 24);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_goneMarginStart, 25);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_goneMarginEnd, 26);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_bias, 29);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintVertical_bias, 30);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintDimensionRatio, 44);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_weight, 45);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintVertical_weight, 46);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_chainStyle, 47);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintVertical_chainStyle, 48);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constrainedWidth, 27);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constrainedHeight, 28);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintWidth_default, 31);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintHeight_default, 32);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintWidth_min, 33);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintWidth_max, 34);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintWidth_percent, 35);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintHeight_min, 36);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintHeight_max, 37);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintHeight_percent, 38);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintLeft_creator, 39);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintTop_creator, 40);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintRight_creator, 41);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintBottom_creator, 42);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_creator, 43);
                map.append(C0148R.styleable.ConstraintLayout_Layout_layout_constraintTag, 51);
            }
        }
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            this.widget = new ConstraintWidget();
            this.helped = false;
            TypedArray a = c.obtainStyledAttributes(attrs, C0148R.styleable.ConstraintLayout_Layout);
            int N = a.getIndexCount();
            int i4 = 0;
            while (i4 < N) {
