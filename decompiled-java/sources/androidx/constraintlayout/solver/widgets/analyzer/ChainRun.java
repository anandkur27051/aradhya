    ...
    */
    public void update(Dependency dependency) {
        ...
        while (j < 2) {
            ...
            if (size2 < distance || numMatchConstraints2 == 0) {
                break;
            }
            numVisibleWidgets = 0;
            numMatchConstraints2 = 0;
            size2 = 0;
            weights2 = 0.0f;
            j++;
            parent2 = parent3;
        ...
        if (numMatchConstraints2 > 0) {
            int matchConstraintsDimension = (int) (((distance - size2) / numMatchConstraints2) + 0.5f);
            int appliedLimits = 0;
            int i6 = 0;
            while (i6 < count) {
                ...
                if (run2.widget.getVisibility() == 8) {
                    ...
                    if (weights2 > 0.0f) {
                        dimension2 = (int) ((((distance - size2) * run2.widget.mWeight[chainRun.orientation]) / weights2) + f3);
                    }
                    if (chainRun.orientation == 0) {
                        ...
                        size = size2;
                        int size3 = run2.matchConstraintsType;
                        numMatchConstraints = numMatchConstraints2;
                        if (size3 != 1) {
                            value = value2;
                        } else {
            ...
            isInRtl = isInRtl3;
            int size4 = size2;
            int numMatchConstraints3 = numMatchConstraints2;
            f = f2;
            if (appliedLimits <= 0) {
                size2 = size4;
                numMatchConstraints2 = numMatchConstraints3;
            } else {
                numMatchConstraints2 = numMatchConstraints3 - appliedLimits;
                int size5 = 0;
        ...
        if (numVisibleWidgets > 0 && numMatchConstraints2 == 0 && firstVisibleWidget == lastVisibleWidget) {
        ...
        if (chainRun.chainStyle == 2) {
            ...
            int gap5 = (int) (((distance - size2) * bias2) + f);
            if (gap5 < 0 || numMatchConstraints2 > 0) {
                gap5 = 0;
            }
            if (isInRtl) {
