...
public class ConstraintWidget {
    ...
    public int getX() {
        if (this.mParent != null && (this.mParent instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) this.mParent).mPaddingLeft + this.f38mX;
        }
        return this.f38mX;
    }
    ...
    public int getY() {
        if (this.mParent != null && (this.mParent instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) this.mParent).mPaddingTop + this.f39mY;
        }
        return this.f39mY;
    }
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (this.horizontalRun.start.resolved && this.horizontalRun.end.resolved && this.verticalRun.start.resolved && this.verticalRun.end.resolved) {
            ...
            if (this.mParent != null) {
                boolean z14 = this.mParent != null && this.mParent.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
                boolean z15 = this.mParent != null && this.mParent.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
        ...
        if (this.mParent == null) {
            ...
            z16 = this.mParent != null && this.mParent.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            z17 = this.mParent != null && this.mParent.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
            if (isChainHead(0)) {
            ...
            if (!isInHorizontalChain && z16 && this.mVisibility != 8 && this.mLeft.mTarget == null && this.mRight.mTarget == null) {
                linearSystem3.addGreaterThan(linearSystem3.createObjectVariable(this.mParent.mRight), createObjectVariable2, 0, 1);
            }
            if (!isInVerticalChain && z17 && this.mVisibility != 8 && this.mTop.mTarget == null && this.mBottom.mTarget == null && this.mBaseline == null) {
                linearSystem3.addGreaterThan(linearSystem3.createObjectVariable(this.mParent.mBottom), createObjectVariable4, 0, 1);
            }
            z = isInHorizontalChain;
        ...
        if (this.mDimensionRatio > 0.0f) {
            ...
            if (this.mVisibility == 8) {
                ...
                if (this.mListDimensionBehaviors[0] != DimensionBehaviour.MATCH_CONSTRAINT || this.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT || i9 != 3 || i10 != 3) {
                    if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && i9 == 3) {
                        this.mResolvedDimensionRatioSide = 0;
                        i7 = (int) (this.mResolvedDimensionRatio * this.mHeight);
                        if (this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT) {
                            i = i8;
                            z3 = true;
                        } else {
                        ...
                        int i11 = (int) (this.mResolvedDimensionRatio * this.mWidth);
                        if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT) {
                            i = i11;
                            z3 = true;
                        } else {
                    ...
                    this.mResolvedMatchConstraintDefault[0] = i9;
                    this.mResolvedMatchConstraintDefault[1] = i10;
                    this.mResolvedHasRatio = z3;
                    if (z3) {
                        if (this.mResolvedDimensionRatioSide != 0) {
                        }
                        z4 = true;
                        z5 = this.mListDimensionBehaviors[0] != DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer);
                        if (z5) {
                            i7 = 0;
                        }
                        ...
                        boolean z21 = this.mIsInBarrier[0];
                        boolean z22 = this.mIsInBarrier[1];
                        boolean z23 = z3;
                        if (this.mHorizontalResolution == 2) {
                            ...
                            if (this.horizontalRun.start.resolved) {
                                if (this.horizontalRun.end.resolved) {
                                    ...
                                    if (this.mParent == null) {
                                        ...
                                        z9 = z23;
                                        i3 = i9;
                                    } else if (!z16 || !this.isTerminalWidget[0] || isInHorizontalChain()) {
                                        solverVariable3 = createObjectVariable;
                                        solverVariable4 = createObjectVariable2;
                                        z7 = z16;
                                        i2 = i10;
                            ...
                            i3 = i9;
                            int i12 = i7;
                            SolverVariable createObjectVariable6 = this.mParent != null ? linearSystem3.createObjectVariable(this.mParent.mRight) : null;
                            z8 = z17;
                            solverVariable4 = createObjectVariable2;
                            z7 = z16;
                            solverVariable6 = solverVariable;
                            ...
                            applyConstraints(linearSystem3, true, z7, z8, this.isTerminalWidget[0], this.mParent != null ? linearSystem3.createObjectVariable(this.mParent.mLeft) : null, createObjectVariable6, this.mListDimensionBehaviors[0], z5, this.mLeft, this.mRight, this.f38mX, i12, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, z4, z, z2, z21, i3, i2, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, z6);
                        }
                        boolean z24 = true;
                        if (this.verticalRun.start.resolved || !this.verticalRun.end.resolved) {
                            ...
                            solverVariable8 = solverVariable5;
                            linearSystem3.addEquality(solverVariable8, this.verticalRun.start.value);
                            solverVariable9 = solverVariable6;
                            linearSystem3.addEquality(solverVariable9, this.verticalRun.end.value);
                            solverVariable10 = solverVariable7;
                            linearSystem3.addEquality(solverVariable10, this.verticalRun.baseline.value);
                            if (this.mParent == null) {
                                z12 = true;
                                i4 = 8;
                                i5 = 0;
                                ...
                                if (!z2 && z8) {
                                    ...
                                    if (this.isTerminalWidget[1]) {
                                        i4 = 8;
                                        i5 = 0;
                                        linearSystem3.addGreaterThan(linearSystem3.createObjectVariable(this.mParent.mBottom), solverVariable9, 0, 8);
                                    }
                                } else {
                                    z13 = true;
                                }
                        ...
                        if (!z11) {
                            ...
                            boolean z25 = (this.mListDimensionBehaviors[z10] == DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer)) ? z10 : i5;
                            if (!z25) {
                                i6 = i;
                            } else {
                                i6 = 0;
                            }
                            boolean z26 = (z9 && (this.mResolvedDimensionRatioSide == z10 || this.mResolvedDimensionRatioSide == -1)) ? z10 : i5;
                            SolverVariable createObjectVariable7 = this.mParent != null ? linearSystem3.createObjectVariable(this.mParent.mBottom) : null;
                            SolverVariable createObjectVariable8 = this.mParent != null ? linearSystem3.createObjectVariable(this.mParent.mTop) : null;
                            if (this.mBaselineDistance > 0 || this.mVisibility == i4) {
                                linearSystem3.addEquality(solverVariable10, solverVariable8, getBaselineDistance(), i4);
                                if (this.mBaseline.mTarget == null) {
                                    if (this.mVisibility == i4) {
                                        linearSystem3.addEquality(solverVariable10, solverVariable8, i5, i4);
                                    }
                                } else {
                                    linearSystem3.addEquality(solverVariable10, linearSystem3.createObjectVariable(this.mBaseline.mTarget), 0, i4);
                                    z6 = false;
                                    if (z8) {
                            ...
                            solverVariable12 = solverVariable9;
                            solverVariable11 = solverVariable8;
                            applyConstraints(linearSystem, false, z8, z7, this.isTerminalWidget[z10], createObjectVariable8, createObjectVariable7, this.mListDimensionBehaviors[z10], z25, this.mTop, this.mBottom, this.f39mY, i6, this.mMinHeight, this.mMaxDimension[z10 ? 1 : 0], this.mVerticalBiasPercent, z26, z2, z, z22, i2, i3, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, z6);
                            constraintWidget = this;
                        }
                        if (!z9) {
                            linearSystem2 = linearSystem;
                        } else {
                            int i13 = constraintWidget.mResolvedDimensionRatioSide;
                            float f = constraintWidget.mResolvedDimensionRatio;
                            if (i13 == 1) {
                                linearSystem.addRatio(solverVariable12, solverVariable11, solverVariable4, solverVariable3, f, 8);
                                linearSystem2 = linearSystem;
                            } else {
                                linearSystem.addRatio(solverVariable4, solverVariable3, solverVariable12, solverVariable11, f, 8);
                                linearSystem2 = linearSystem;
                            }
                        }
                        if (constraintWidget.mCenter.isConnected()) {
                            linearSystem2.addCenterPoint(constraintWidget, constraintWidget.mCenter.getTarget().getOwner(), (float) Math.toRadians(constraintWidget.mCircleConstraintAngle + 90.0f), constraintWidget.mCenter.getMargin());
                            return;
                        }
                        return;
                    }
                    ...
                    boolean z212 = this.mIsInBarrier[0];
                    boolean z222 = this.mIsInBarrier[1];
                    boolean z232 = z3;
                    if (this.mHorizontalResolution == 2) {
                    }
                    boolean z242 = true;
                    ...
                    setupDimensionRatio(z16, z17, z18, z19);
                }
            }
        } else {
            solverVariable = createObjectVariable4;
        ...
        boolean z2122 = this.mIsInBarrier[0];
        boolean z2222 = this.mIsInBarrier[1];
        boolean z2322 = z3;
        if (this.mHorizontalResolution == 2) {
        }
        boolean z2422 = true;
