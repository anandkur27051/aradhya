...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object anchor) {
        ...
        if (anchor instanceof ConstraintAnchor) {
            ...
            if (variable.f34id == -1 || variable.f34id > this.mVariablesID || this.mCache.mIndexedVariables[variable.f34id] == null) {
                if (variable.f34id != -1) {
                    variable.reset();
                }
                this.mVariablesID++;
                this.mNumColumns++;
                variable.f34id = this.mVariablesID;
    ...
    private final int optimize(Row goal, boolean b) {
        ...
        while (!done) {
            ...
            if (goal.getKey() != null) {
                this.mAlreadyTestedCandidates[goal.getKey().f34id] = USE_SYNONYMS;
            }
            ...
            if (pivotCandidate != null) {
                ...
                this.mAlreadyTestedCandidates[pivotCandidate.f34id] = USE_SYNONYMS;
            }
            if (pivotCandidate != null) {
