...
public class PriorityGoalRow extends ArrayRow {
    ...
    class GoalVariableAccessor implements Comparable {
        ...
        public int compareTo(Object o) {
            ...
            return this.variable.f34id - v.f34id;
        }
    ...
    private final void addToGoal(SolverVariable variable) {
        ...
        this.numGoals++;
        if (this.numGoals > 1 && this.arrayGoals[this.numGoals - 1].f34id > variable.f34id) {
            int i = 0;
            while (true) {
            ...
            Arrays.sort(solverVariableArr, 0, i3, new Comparator<SolverVariable>() { // from class: androidx.constraintlayout.solver.PriorityGoalRow.1
                ...
                public int compare(SolverVariable variable1, SolverVariable variable2) {
                    return variable1.f34id - variable2.f34id;
                }
            });
