...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        private void saturation(float saturationStrength) {
            ...
            float Gt = 0.587f * MS;
            float Bt = 0.114f * MS;
            this.f48m[0] = Rt + saturationStrength;
            this.f48m[1] = Gt;
            this.f48m[2] = Bt;
            this.f48m[3] = 0.0f;
            this.f48m[4] = 0.0f;
            this.f48m[5] = Rt;
            this.f48m[6] = Gt + saturationStrength;
            this.f48m[7] = Bt;
            this.f48m[8] = 0.0f;
            this.f48m[9] = 0.0f;
            this.f48m[10] = Rt;
            this.f48m[11] = Gt;
            this.f48m[12] = Bt + saturationStrength;
            this.f48m[13] = 0.0f;
            this.f48m[14] = 0.0f;
            this.f48m[15] = 0.0f;
            this.f48m[16] = 0.0f;
        ...
        private void warmth(float warmth) {
            ...
            this.f48m[0] = color_r / tmpColor_r2;
            this.f48m[1] = 0.0f;
            this.f48m[2] = 0.0f;
            this.f48m[3] = 0.0f;
            this.f48m[4] = 0.0f;
        ...
        private void brightness(float brightness) {
            this.f48m[0] = brightness;
            this.f48m[1] = 0.0f;
            this.f48m[2] = 0.0f;
            this.f48m[3] = 0.0f;
            this.f48m[4] = 0.0f;
            this.f48m[5] = 0.0f;
            this.f48m[6] = brightness;
            this.f48m[7] = 0.0f;
            this.f48m[8] = 0.0f;
            this.f48m[9] = 0.0f;
            this.f48m[10] = 0.0f;
            this.f48m[11] = 0.0f;
            this.f48m[12] = brightness;
            this.f48m[13] = 0.0f;
            this.f48m[14] = 0.0f;
            this.f48m[15] = 0.0f;
            this.f48m[16] = 0.0f;
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, C0148R.styleable.ImageFilterView);
            int N = a.getIndexCount();
            Drawable drawable = a.getDrawable(C0148R.styleable.ImageFilterView_altSrc);
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0148R.styleable.ImageFilterView_crossfade) {
                    this.mCrossfade = a.getFloat(attr, 0.0f);
                } else if (attr == C0148R.styleable.ImageFilterView_warmth) {
                    setWarmth(a.getFloat(attr, 0.0f));
                } else if (attr == C0148R.styleable.ImageFilterView_saturation) {
                    setSaturation(a.getFloat(attr, 0.0f));
                } else if (attr == C0148R.styleable.ImageFilterView_contrast) {
                    setContrast(a.getFloat(attr, 0.0f));
                } else if (attr == C0148R.styleable.ImageFilterView_round) {
                    setRound(a.getDimension(attr, 0.0f));
                } else if (attr == C0148R.styleable.ImageFilterView_roundPercent) {
                    setRoundPercent(a.getFloat(attr, 0.0f));
                } else if (attr == C0148R.styleable.ImageFilterView_overlay) {
