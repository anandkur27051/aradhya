...
@Metadata(m129d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\u001a3\u0010\u0000\u001a\u00020\u0001*\u00020\u00022\u001c\u0010\u0003\u001a\u0018\b\u0001\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00010\u0005\u0012\u0006\u0012\u0004\u0018\u00010\u00060\u0004H\u0086Hø\u0001\u0000¢\u0006\u0002\u0010\u0007\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\b"}, m130d2 = {"reportWhenComplete", "", "Landroidx/activity/FullyDrawnReporter;", "reporter", "Lkotlin/Function1;", "Lkotlin/coroutines/Continuation;", "", "(Landroidx/activity/FullyDrawnReporter;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "activity_release"}, m131k = 2, m132mv = {1, 8, 0}, m134xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public static final Object reportWhenComplete(FullyDrawnReporter $this$reportWhenComplete, Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof FullyDrawnReporterKt$reportWhenComplete$1) {
            ...
            if ((fullyDrawnReporterKt$reportWhenComplete$1.label & Integer.MIN_VALUE) != 0) {
                ...
                Object $result = fullyDrawnReporterKt$reportWhenComplete$1.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch (fullyDrawnReporterKt$reportWhenComplete$1.label) {
                    case 0:
                        ...
                        try {
                            fullyDrawnReporterKt$reportWhenComplete$1.L$0 = $this$reportWhenComplete;
                    ...
                    case 1:
                        $this$reportWhenComplete2 = (FullyDrawnReporter) fullyDrawnReporterKt$reportWhenComplete$1.L$0;
                        try {
                            ResultKt.throwOnFailure($result);
                            $this$reportWhenComplete2.removeReporter();
                            return Unit.INSTANCE;
        ...
        Object $result2 = fullyDrawnReporterKt$reportWhenComplete$1.result;
