...
import androidx.coordinatorlayout.C0149R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0149R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (defStyleAttr == 0) {
            obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0149R.styleable.CoordinatorLayout, 0, C0149R.style.Widget_Support_CoordinatorLayout);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0149R.styleable.CoordinatorLayout, defStyleAttr, 0);
        }
        ...
        if (Build.VERSION.SDK_INT < 29) {
            ...
            context2 = context;
            saveAttributeDataForStyleable(context2, C0149R.styleable.CoordinatorLayout, attrs, a, 0, C0149R.style.Widget_Support_CoordinatorLayout);
        } else {
            context2 = context;
            saveAttributeDataForStyleable(context2, C0149R.styleable.CoordinatorLayout, attrs, a, defStyleAttr, 0);
        }
        int keylineArrayRes = a.getResourceId(C0149R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0149R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
    ...
    */
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int paddingTop3 = coordinatorLayout.getPaddingTop();
        int paddingRight3 = coordinatorLayout.getPaddingRight();
        int paddingBottom2 = coordinatorLayout.getPaddingBottom();
        ...
        int widthPadding = paddingLeft2 + paddingRight3;
        int heightPadding = paddingTop3 + paddingBottom2;
        int keylineWidthUsed = coordinatorLayout.getSuggestedMinimumWidth();
        int heightUsed2 = coordinatorLayout.getSuggestedMinimumHeight();
        int childState = 0;
        boolean applyInsets = coordinatorLayout.mLastInsets != null && ViewCompat.getFitsSystemWindows(coordinatorLayout);
        int childCount = coordinatorLayout.mDependencySortedChildren.size();
        int heightUsed3 = 0;
        while (heightUsed3 < childCount) {
            View child2 = coordinatorLayout.mDependencySortedChildren.get(heightUsed3);
            int childCount2 = childCount;
            int childCount3 = child2.getVisibility();
            int widthUsed2 = keylineWidthUsed;
            if (childCount3 == 8) {
                ...
                keylineWidthUsed = widthUsed2;
                widthUsed = paddingLeft2;
            } else {
                LayoutParams lp3 = (LayoutParams) child2.getLayoutParams();
                int keylineWidthUsed2 = lp3.keyline;
                if (keylineWidthUsed2 < 0 || widthMode == 0) {
                    lp = lp3;
                    heightUsed = heightUsed2;
                } else {
                    int keylinePos = coordinatorLayout.getKeyline(lp3.keyline);
                    int keylineGravity2 = GravityCompat.getAbsoluteGravity(resolveKeylineGravity(lp3.gravity), layoutDirection) & 7;
                    lp = lp3;
                    if ((keylineGravity2 == 3 && !isRtl) || (keylineGravity2 == 5 && isRtl)) {
                        heightUsed = heightUsed2;
                        keylineGravity = Math.max(0, (widthSize - paddingRight3) - keylinePos);
                    } else {
                        heightUsed = heightUsed2;
                        if ((keylineGravity2 == 5 && !isRtl) || (keylineGravity2 == 3 && isRtl)) {
                            keylineGravity = Math.max(0, keylinePos - paddingLeft2);
                        }
                    }
                    if (!applyInsets && !ViewCompat.getFitsSystemWindows(child2)) {
                        int horizInsets2 = coordinatorLayout.mLastInsets.getSystemWindowInsetLeft() + coordinatorLayout.mLastInsets.getSystemWindowInsetRight();
                        int vertInsets2 = coordinatorLayout.mLastInsets.getSystemWindowInsetTop() + coordinatorLayout.mLastInsets.getSystemWindowInsetBottom();
                        int childWidthMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(widthSize - horizInsets2, widthMode);
                        int childWidthMeasureSpec3 = heightSize - vertInsets2;
                        horizInsets = View.MeasureSpec.makeMeasureSpec(childWidthMeasureSpec3, heightMode2);
                        vertInsets = childWidthMeasureSpec2;
                    } else {
                        horizInsets = heightMeasureSpec;
                        vertInsets = widthMeasureSpec;
                    }
                    b = lp.getBehavior();
                    if (b == null) {
                        i = heightUsed3;
                        heightMode = heightMode2;
                        widthUsed = paddingLeft2;
                        paddingLeft = widthUsed2;
                        LayoutParams layoutParams = lp;
                        paddingBottom = paddingBottom2;
                        lp2 = layoutParams;
                        paddingTop = paddingTop3;
                        paddingRight = paddingRight3;
                        paddingRight2 = heightUsed;
                        paddingTop2 = childState;
                        int childState2 = horizInsets;
                        int childHeightMeasureSpec = keylineGravity;
                        int keylineWidthUsed3 = vertInsets;
                        boolean onMeasureChild = b.onMeasureChild(this, child2, keylineWidthUsed3, childHeightMeasureSpec, childState2, 0);
                        child = child2;
                        childWidthMeasureSpec = keylineWidthUsed3;
                        keylineGravity = childHeightMeasureSpec;
                        horizInsets = childState2;
                        if (onMeasureChild) {
                            coordinatorLayout = this;
                            int widthUsed3 = Math.max(paddingLeft, widthPadding + child.getMeasuredWidth() + lp2.leftMargin + lp2.rightMargin);
                            int heightUsed4 = Math.max(paddingRight2, heightPadding + child.getMeasuredHeight() + lp2.topMargin + lp2.bottomMargin);
                            keylineWidthUsed = widthUsed3;
                            heightUsed2 = heightUsed4;
                            childState = View.combineMeasuredStates(paddingTop2, child.getMeasuredState());
                        }
                    } else {
                        int i2 = heightMode2;
                        childWidthMeasureSpec = vertInsets;
                        child = child2;
                        heightMode = i2;
                        widthUsed = paddingLeft2;
                        paddingLeft = widthUsed2;
                    ...
                    coordinatorLayout = this;
                    coordinatorLayout.onMeasureChild(child, childWidthMeasureSpec, keylineGravity, horizInsets, 0);
                    int widthUsed32 = Math.max(paddingLeft, widthPadding + child.getMeasuredWidth() + lp2.leftMargin + lp2.rightMargin);
                    int heightUsed42 = Math.max(paddingRight2, heightPadding + child.getMeasuredHeight() + lp2.topMargin + lp2.bottomMargin);
                    keylineWidthUsed = widthUsed32;
                    heightUsed2 = heightUsed42;
                    childState = View.combineMeasuredStates(paddingTop2, child.getMeasuredState());
                }
                keylineGravity = 0;
                if (!applyInsets) {
                ...
                coordinatorLayout = this;
                coordinatorLayout.onMeasureChild(child, childWidthMeasureSpec, keylineGravity, horizInsets, 0);
                int widthUsed322 = Math.max(paddingLeft, widthPadding + child.getMeasuredWidth() + lp2.leftMargin + lp2.rightMargin);
                int heightUsed422 = Math.max(paddingRight2, heightPadding + child.getMeasuredHeight() + lp2.topMargin + lp2.bottomMargin);
                keylineWidthUsed = widthUsed322;
                heightUsed2 = heightUsed422;
                childState = View.combineMeasuredStates(paddingTop2, child.getMeasuredState());
            }
            heightUsed3 = i + 1;
            heightMode2 = heightMode;
            childCount = childCount2;
            paddingLeft2 = widthUsed;
            paddingTop3 = paddingTop;
            paddingRight3 = paddingRight;
            paddingBottom2 = paddingBottom;
        }
        int paddingTop4 = childState;
        int width = View.resolveSizeAndState(keylineWidthUsed, widthMeasureSpec, (-16777216) & paddingTop4);
        int height = View.resolveSizeAndState(heightUsed2, heightMeasureSpec, paddingTop4 << 16);
        coordinatorLayout.setMeasuredDimension(width, height);
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.dodgeInsetEdges = 0;
            this.mLastChildRect = new Rect();
            TypedArray a = context.obtainStyledAttributes(attrs, C0149R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0149R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0149R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0149R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0149R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0149R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0149R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a.hasValue(C0149R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0149R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
