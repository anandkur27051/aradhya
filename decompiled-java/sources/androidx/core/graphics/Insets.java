...
public final class Insets {
    ...
    /* renamed from: of */
    public static Insets m9of(int left, int top, int right, int bottom) {
    ...
    /* renamed from: of */
    public static Insets m10of(Rect r) {
        return m9of(r.left, r.top, r.right, r.bottom);
    }

    public static Insets add(Insets a, Insets b) {
        return m9of(a.left + b.left, a.top + b.top, a.right + b.right, a.bottom + b.bottom);
    }
    ...
    public static Insets max(Insets a, Insets b) {
        return m9of(Math.max(a.left, b.left), Math.max(a.top, b.top), Math.max(a.right, b.right), Math.max(a.bottom, b.bottom));
    }

    public static Insets min(Insets a, Insets b) {
        return m9of(Math.min(a.left, b.left), Math.min(a.top, b.top), Math.min(a.right, b.right), Math.min(a.bottom, b.bottom));
    }
    ...
    static class Api29Impl {
        ...
        /* renamed from: of */
        static android.graphics.Insets m11of(int left, int top, int right, int bottom) {
