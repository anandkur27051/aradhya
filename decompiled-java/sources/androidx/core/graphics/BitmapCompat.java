    ...
    public static Bitmap createScaledBitmap(Bitmap srcBm, int dstW, int dstH, Rect srcRect, boolean scaleInLinearSpace) {
        ...
        if (!scaleInLinearSpace) {
            ...
            if (!Api27Impl.isAlreadyF16AndLinear(srcBm)) {
                ...
                int allocH = totalStepsY2;
                allocW = stepsX;
                Paint paint3 = paint;
                Bitmap dst3 = Api27Impl.createBitmapWithSourceColorspace(allocW2, allocH, srcBm, r3);
                Canvas canvasForCopy2 = new Canvas(dst3);
                int allocW3 = srcX;
                int allocH2 = -allocW3;
                paint = paint3;
                canvasForCopy2.drawBitmap(src, allocH2, -srcY3, paint);
                srcX3 = 0;
                srcY3 = 0;
                dst2 = src;
                src = dst3;
                ...
                while (true) {
                    ...
                    int nextH = sizeAtStep(srcH, i3, stepsY, totalStepsY);
                    stepsX2 = srcY2;
                    nextRect.set(0, 0, nextW, nextH);
                    lastStep = stepsX2 != 0 && stepsY == 0;
                    ...
                    if (dst != null || dst == srcBm || ((scaleInLinearSpace && !Api27Impl.isAlreadyF16AndLinear(dst)) || (lastStep && (!dstSizeIsFinal || i4 != 0)))) {
                        ...
                        int allocW4 = sizeAtStep(srcW, i2, stepsX2 <= 0 ? lastScratchStep : stepsX2, totalStepsX);
                        int allocH3 = sizeAtStep(srcH, i3, stepsY <= 0 ? lastScratchStep : stepsY, totalStepsY);
                        boolean linear = (scaleInLinearSpace || lastStep) ? false : true;
                        Bitmap dst4 = Api27Impl.createBitmapWithSourceColorspace(allocW4, allocH3, srcBm, linear);
                        dst = dst4;
                    }
        ...
        while (true) {
            ...
            int nextH2 = sizeAtStep(srcH, i3, stepsY, totalStepsY);
            stepsX2 = srcY2;
            ...
            int allocW42 = sizeAtStep(srcW, i2, stepsX2 <= 0 ? lastScratchStep2 : stepsX2, totalStepsX);
            int allocH32 = sizeAtStep(srcH, i3, stepsY <= 0 ? lastScratchStep2 : stepsY, totalStepsY);
            boolean linear2 = (scaleInLinearSpace || lastStep) ? false : true;
            Bitmap dst42 = Api27Impl.createBitmapWithSourceColorspace(allocW42, allocH32, srcBm, linear2);
            dst = dst42;
