...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                ...
                contentView.setImageViewBitmap(C0152R.id.icon, this.mBuilder.mLargeIcon);
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    int backgroundSize = res.getDimensionPixelSize(C0152R.dimen.notification_right_icon_size);
                    int iconSize = backgroundSize - (res.getDimensionPixelSize(C0152R.dimen.notification_small_icon_background_padding) * 2);
                    Bitmap smallBit = createIconWithBackground(this.mBuilder.mNotification.icon, backgroundSize, iconSize, this.mBuilder.getColor());
                    contentView.setImageViewBitmap(C0152R.id.right_icon, smallBit);
                    contentView.setViewVisibility(C0152R.id.right_icon, 0);
                }
            } else if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C0152R.id.icon, 0);
                int backgroundSize2 = res.getDimensionPixelSize(C0152R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0152R.dimen.notification_big_circle_margin);
                int iconSize2 = res.getDimensionPixelSize(C0152R.dimen.notification_small_icon_size_as_large);
                ...
                contentView.setImageViewBitmap(C0152R.id.icon, smallBit2);
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0152R.id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0152R.id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0152R.id.info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(C0152R.id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                int tooBig = res.getInteger(C0152R.integer.status_bar_notification_info_maxnum);
                if (this.mBuilder.mNumber > tooBig) {
                    contentView.setTextViewText(C0152R.id.info, res.getString(C0152R.string.status_bar_notification_info_overflow));
                } else {
                    NumberFormat f = NumberFormat.getIntegerInstance();
                    contentView.setTextViewText(C0152R.id.info, f.format(this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0152R.id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            ...
            if (this.mBuilder.mSubText != null) {
                contentView.setTextViewText(C0152R.id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0152R.id.text2, this.mBuilder.mContentText);
            ...
            if (showLine2) {
                if (fitIn1U) {
                    float subTextSize = res.getDimensionPixelSize(C0152R.dimen.notification_subtext_size);
                    Api16Impl.setTextViewTextSize(contentView, C0152R.id.text, 0, subTextSize);
                }
                Api16Impl.setViewPadding(contentView, C0152R.id.line1, 0, 0, 0, 0);
            }
            if (this.mBuilder.getWhenIfShowing() != 0) {
                if (this.mBuilder.mUseChronometer) {
                    contentView.setViewVisibility(C0152R.id.chronometer, 0);
                    contentView.setLong(C0152R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(C0152R.id.chronometer, "setStarted", true);
                    if (this.mBuilder.mChronometerCountDown) {
                        Api24Impl.setChronometerCountDown(contentView, C0152R.id.chronometer, this.mBuilder.mChronometerCountDown);
                    }
                } else {
                    contentView.setViewVisibility(C0152R.id.time, 0);
                    contentView.setLong(C0152R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                }
                hasRightSide = true;
            }
            contentView.setViewVisibility(C0152R.id.right_side, hasRightSide ? 0 : i);
            contentView.setViewVisibility(C0152R.id.line3, showLine3 ? 0 : i);
            return contentView;
        }
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0152R.drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0152R.id.notification_main_column);
            outerView.addView(C0152R.id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0152R.id.notification_main_column, 0);
            Api16Impl.setViewPadding(outerView, C0152R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0152R.id.title, 8);
            outerView.setViewVisibility(C0152R.id.text2, 8);
            outerView.setViewVisibility(C0152R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0152R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0152R.dimen.notification_top_pad_large_text);
    ...
    public static class CallStyle extends Style {
        ...
        private String getDefaultText() {
            switch (this.mCallType) {
                case 1:
                    return this.mBuilder.mContext.getResources().getString(C0152R.string.call_notification_incoming_text);
                case 2:
                    return this.mBuilder.mContext.getResources().getString(C0152R.string.call_notification_ongoing_text);
                case 3:
                    return this.mBuilder.mContext.getResources().getString(C0152R.string.call_notification_screening_text);
                default:
                    return null;
            }
        }
        ...
        private Action makeNegativeAction() {
            int i = C0152R.drawable.ic_call_decline_low;
            int icon = C0152R.drawable.ic_call_decline;
            if (this.mDeclineIntent == null) {
                return makeAction(icon, C0152R.string.call_notification_hang_up_action, this.mDeclineButtonColor, C0152R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(icon, C0152R.string.call_notification_decline_action, this.mDeclineButtonColor, C0152R.color.call_notification_decline_color, this.mDeclineIntent);
        }

        private Action makeAnswerAction() {
            int i = C0152R.drawable.ic_call_answer_video_low;
            int i2 = C0152R.drawable.ic_call_answer_low;
            int videoIcon = C0152R.drawable.ic_call_answer_video;
            int icon = C0152R.drawable.ic_call_answer;
            if (this.mAnswerIntent == null) {
                return null;
            }
            return makeAction(this.mIsVideo ? videoIcon : icon, this.mIsVideo ? C0152R.string.call_notification_answer_video_action : C0152R.string.call_notification_answer_action, this.mAnswerButtonColor, C0152R.color.call_notification_answer_color, this.mAnswerIntent);
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            int numActions;
            RemoteViews remoteViews = applyStandardTemplate(true, C0152R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0152R.id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C0152R.id.actions, button);
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews.setViewVisibility(C0152R.id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0152R.id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0152R.layout.notification_action_tombstone : C0152R.layout.notification_action);
            IconCompat icon = action.getIconCompat();
            if (icon != null) {
                button.setImageViewBitmap(C0152R.id.action_image, createColoredBitmap(icon, C0152R.color.notification_action_color_filter));
            }
            button.setTextViewText(C0152R.id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0152R.id.action_container, action.actionIntent);
            }
            Api15Impl.setContentDescription(button, C0152R.id.action_container, action.title);
            return button;
        }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m165clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m166clone() {
            WearableExtender that = new WearableExtender();
