...
public abstract class Visibility extends Transition {
    ...
    /* JADX WARN: Type inference failed for: r20v0, types: [androidx.transition.Visibility] */
    public Animator onDisappear(final ViewGroup viewGroup, TransitionValues transitionValues, int i, TransitionValues transitionValues2, int i2) {
        ...
        View view4 = null;
        boolean z2 = false;
        View view5 = (View) view.getTag(C0429R.id.save_overlay_view);
        if (view5 != null) {
            view3 = view5;
            z2 = true;
            animator = null;
        ...
        if (view3 != null) {
            ...
            if (!z2) {
                if (onDisappear == null) {
                    ...
                    view.setTag(C0429R.id.save_overlay_view, view3);
                    ...
                    addListener(new TransitionListenerAdapter() { // from class: androidx.transition.Visibility.1
                        ...
                        public void onTransitionPause(Transition transition) {
                            ViewGroupUtils.getOverlay(viewGroup).remove(view7);
                        }

                        @Override // androidx.transition.TransitionListenerAdapter, androidx.transition.Transition.TransitionListener
                        public void onTransitionResume(Transition transition) {
                            if (view7.getParent() == null) {
                                ViewGroupUtils.getOverlay(viewGroup).add(view7);
                            } else {
                        ...
                        public void onTransitionEnd(Transition transition) {
                            view.setTag(C0429R.id.save_overlay_view, null);
                            ViewGroupUtils.getOverlay(viewGroup).remove(view7);
