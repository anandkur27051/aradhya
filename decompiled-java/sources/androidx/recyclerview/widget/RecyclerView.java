...
import androidx.recyclerview.C0355R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C0355R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, C0355R.styleable.RecyclerView, defStyleAttr, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0355R.styleable.RecyclerView, attrs, a2, defStyleAttr, 0);
            a = a2;
        } else {
            a = a2;
        }
        String layoutManagerName = a.getString(C0355R.styleable.RecyclerView_layoutManager);
        int descendantFocusability = a.getInt(C0355R.styleable.RecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C0355R.styleable.RecyclerView_android_clipToPadding, true);
        this.mEnableFastScroller = a.getBoolean(C0355R.styleable.RecyclerView_fastScrollEnabled, false);
        if (this.mEnableFastScroller) {
            StateListDrawable verticalThumbDrawable = (StateListDrawable) a.getDrawable(C0355R.styleable.RecyclerView_fastScrollVerticalThumbDrawable);
            Drawable verticalTrackDrawable = a.getDrawable(C0355R.styleable.RecyclerView_fastScrollVerticalTrackDrawable);
            StateListDrawable horizontalThumbDrawable = (StateListDrawable) a.getDrawable(C0355R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable);
            Drawable horizontalTrackDrawable = a.getDrawable(C0355R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable);
    ...
    */
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0355R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0355R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0355R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0355R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0355R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0355R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0355R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0355R.dimen.fastscroll_margin));
    }
