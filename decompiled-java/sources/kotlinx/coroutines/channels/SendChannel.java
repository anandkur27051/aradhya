...
public interface SendChannel<E> {
    ...
    Object mo1682trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1682trySendJP2dKIU(e);
            if (ChannelResult.m1697isSuccessimpl(result)) {
                return true;
            }
            Throwable m1691exceptionOrNullimpl = ChannelResult.m1691exceptionOrNullimpl(result);
