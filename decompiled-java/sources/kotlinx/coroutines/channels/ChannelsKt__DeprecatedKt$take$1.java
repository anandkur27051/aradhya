...
@Metadata(m129d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m130d2 = {"<anonymous>", "", "E", "Lkotlinx/coroutines/channels/ProducerScope;"}, m131k = 3, m132mv = {1, 6, 0}, m134xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m140c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$take$1", m141f = "Deprecated.kt", m142i = {0, 0, 1, 1}, m143l = {254, 255}, m144m = "invokeSuspend", m145n = {"$this$produce", "remaining", "$this$produce", "remaining"}, m146s = {"L$0", "I$0", "L$0", "I$0"})
...
final class ChannelsKt__DeprecatedKt$take$1<E> extends SuspendLambda implements Function2<ProducerScope<? super E>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ChannelsKt__DeprecatedKt$take$1 channelsKt__DeprecatedKt$take$1 = new ChannelsKt__DeprecatedKt$take$1(this.f218$n, this.$this_take, continuation);
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (channelsKt__DeprecatedKt$take$1.f218$n == 0) {
                    return Unit.INSTANCE;
                }
                boolean z = channelsKt__DeprecatedKt$take$1.f218$n >= 0;
                int i = channelsKt__DeprecatedKt$take$1.f218$n;
                if (!z) {
                    throw new IllegalArgumentException(("Requested element count " + i + " is less than zero.").toString());
                }
                remaining = channelsKt__DeprecatedKt$take$1.f218$n;
