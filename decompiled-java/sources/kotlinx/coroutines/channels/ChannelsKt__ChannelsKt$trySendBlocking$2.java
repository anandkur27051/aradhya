...
@Metadata(m129d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001\"\u0004\b\u0000\u0010\u0003*\u00020\u0004H\u008a@"}, m130d2 = {"<anonymous>", "Lkotlinx/coroutines/channels/ChannelResult;", "", "E", "Lkotlinx/coroutines/CoroutineScope;"}, m131k = 3, m132mv = {1, 6, 0}, m134xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m140c = "kotlinx.coroutines.channels.ChannelsKt__ChannelsKt$trySendBlocking$2", m141f = "Channels.kt", m142i = {}, m143l = {39}, m144m = "invokeSuspend", m145n = {}, m146s = {})
        ...
        switch (this.label) {
            case 0:
                ...
                try {
                    ...
                    r = Result.m187constructorimpl(ResultKt.createFailure(th));
                    return ChannelResult.m1687boximpl(!Result.m194isSuccessimpl(r) ? ChannelResult.INSTANCE.m1702successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1700closedJP2dKIU(Result.m190exceptionOrNullimpl(r)));
                }
                if (sendChannel.send(e, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                r = Result.m187constructorimpl(Unit.INSTANCE);
                return ChannelResult.m1687boximpl(!Result.m194isSuccessimpl(r) ? ChannelResult.INSTANCE.m1702successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1700closedJP2dKIU(Result.m190exceptionOrNullimpl(r)));
            case 1:
                try {
                    ResultKt.throwOnFailure($result);
