...
public interface ReceiveChannel<E> {
    ...
    Object mo1680receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1681tryReceivePtdJZtk = receiveChannel.mo1681tryReceivePtdJZtk();
            if (ChannelResult.m1697isSuccessimpl(mo1681tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1693getOrThrowimpl(mo1681tryReceivePtdJZtk);
            }
            Throwable m1691exceptionOrNullimpl = ChannelResult.m1691exceptionOrNullimpl(mo1681tryReceivePtdJZtk);
            if (m1691exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1691exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    Object $result = receiveChannel$receiveOrNull$1.result;
                    Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    switch (receiveChannel$receiveOrNull$1.label) {
                        case 0:
                            ResultKt.throwOnFailure($result);
                            receiveChannel$receiveOrNull$1.label = 1;
                            mo1680receiveCatchingJP2dKIU = receiveChannel.mo1680receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        ...
                        case 1:
                            ResultKt.throwOnFailure($result);
                            mo1680receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                            break;
                        default:
                            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                    return ChannelResult.m1692getOrNullimpl(mo1680receiveCatchingJP2dKIU);
                }
            }
            receiveChannel$receiveOrNull$1 = new ReceiveChannel$receiveOrNull$1(continuation);
            Object $result2 = receiveChannel$receiveOrNull$1.result;
