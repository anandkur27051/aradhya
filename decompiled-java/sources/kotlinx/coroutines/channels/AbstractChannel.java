...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo1680receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        if (continuation instanceof AbstractChannel$receiveCatching$1) {
            ...
            if ((abstractChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                ...
                Object $result = abstractChannel$receiveCatching$1.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch (abstractChannel$receiveCatching$1.label) {
                    case 0:
                        ResultKt.throwOnFailure($result);
                        Object result = pollInternal();
                        if (result != AbstractChannelKt.POLL_FAILED) {
                            return result instanceof Closed ? ChannelResult.INSTANCE.m1700closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1702successJP2dKIU(result);
                        }
                        abstractChannel$receiveCatching$1.label = 1;
                        receiveSuspend = receiveSuspend(1, abstractChannel$receiveCatching$1);
        ...
        Object $result2 = abstractChannel$receiveCatching$1.result;
    ...
    public final Object mo1681tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1701failurePtdJZtk() : result instanceof Closed ? ChannelResult.INSTANCE.m1700closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1702successJP2dKIU(result);
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m1719constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                if (!previous.mo1727remove()) {
                    previous.helpRemove();
                } else {
                    list = InlineList.m1724plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo1679onCancelIdempotentListww6eGU(list, closed);
                return;
            }
        }
    }
    ...
    protected void mo1679onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) {
            ...
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1687boximpl(ChannelResult.INSTANCE.m1700closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
        ...
        if (receiveMode != 1) {
            ...
            Object $this$toResult$iv = ChannelResult.m1687boximpl(value instanceof Closed ? ChannelResult.INSTANCE.m1700closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.INSTANCE.m1702successJP2dKIU(value));
    ...
    public static final class Itr<E> implements ChannelIterator<E> {
        ...
        public final Object hasNextSuspend(Continuation<? super Boolean> continuation) {
            ...
            while (true) {
                boolean enqueueReceive = this.channel.enqueueReceive(receive);
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m187constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cont.resumeWith(Result.m187constructorimpl(ResultKt.createFailure(((Closed) result).getReceiveException())));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1687boximpl(ChannelResult.INSTANCE.m1702successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            ...
            if (i != 1) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m187constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            } else {
                ChannelResult m1687boximpl = ChannelResult.m1687boximpl(ChannelResult.INSTANCE.m1700closedJP2dKIU(closed.closeCause));
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m187constructorimpl(m1687boximpl));
            }
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E value) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1687boximpl(ChannelResult.INSTANCE.m1702successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        return;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1687boximpl(ChannelResult.INSTANCE.m1700closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        return;
                    default:
                        return;
                }
