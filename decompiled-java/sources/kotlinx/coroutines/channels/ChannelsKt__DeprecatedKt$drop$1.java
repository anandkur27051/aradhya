...
@DebugMetadata(m140c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$drop$1", m141f = "Deprecated.kt", m142i = {0, 0, 1, 2}, m143l = {164, 169, 170}, m144m = "invokeSuspend", m145n = {"$this$produce", "remaining", "$this$produce", "$this$produce"}, m146s = {"L$0", "I$0", "L$0", "L$0"})
...
final class ChannelsKt__DeprecatedKt$drop$1<E> extends SuspendLambda implements Function2<ProducerScope<? super E>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ChannelsKt__DeprecatedKt$drop$1 channelsKt__DeprecatedKt$drop$1 = new ChannelsKt__DeprecatedKt$drop$1(this.f217$n, this.$this_drop, continuation);
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                boolean z = channelsKt__DeprecatedKt$drop$1.f217$n >= 0;
                int i = channelsKt__DeprecatedKt$drop$1.f217$n;
                if (!z) {
                    throw new IllegalArgumentException(("Requested element count " + i + " is less than zero.").toString());
                }
                int remaining2 = channelsKt__DeprecatedKt$drop$1.f217$n;
                if (remaining2 > 0) {
