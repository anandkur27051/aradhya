...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation() {
        while (true) {
            ...
            if (state instanceof CancellableContinuationImpl) {
                if (C0119xc40028dd.m6m(_reusableCancellableContinuation$FU, this, state, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
    ...
    public final Throwable tryReleaseClaimedContinuation(CancellableContinuation<?> continuation) {
        do {
            ...
            if (state != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (state instanceof Throwable) {
                    if (!C0119xc40028dd.m6m(_reusableCancellableContinuation$FU, this, state, null)) {
        ...
        } while (!C0119xc40028dd.m6m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, continuation));
        return null;
    }
    ...
    public final boolean postponeCancellation(Throwable cause) {
        while (true) {
            ...
            if (Intrinsics.areEqual(state, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (C0119xc40028dd.m6m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, cause)) {
                    return true;
                }
            } else {
                if (state instanceof Throwable) {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context)) {
            this._state = state;
            this.resumeMode = 0;
            this.dispatcher.mo1728dispatch(context, this);
            return;
        }
        if (DebugKt.getASSERTIONS_ENABLED()) {
        }
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(13:13|14|15|16|(2:17|18)|(3:77|78|(8:80|81|21|(12:23|24|25|(2:27|28)(3:68|69|70)|29|30|31|32|33|34|(1:46)|38)(1:75)|39|(1:40)|43|44))|20|21|(0)(0)|39|(1:40)|43|44) */
    ...
    */
    public final void resumeCancellableWith(Object result, Function1<? super Throwable, Unit> onCancellation) {
        ...
        if (this.dispatcher.isDispatchNeeded(getContext())) {
            this._state = state;
            this.resumeMode = 1;
            this.dispatcher.mo1728dispatch(getContext(), this);
            return;
        }
        if (DebugKt.getASSERTIONS_ENABLED()) {
        }
        ...
        try {
            ...
            e$iv$iv = th3;
            try {
                $this$runUnconfinedEventLoop$iv$iv.handleFatalException(e$iv$iv, th);
            } finally {
        ...
        if (job$iv != null) {
            ...
            if (!job$iv.isActive()) {
                ...
                resumeWith(Result.m187constructorimpl(ResultKt.createFailure(cause$iv)));
                z = true;
                if (z) {
                    ...
                    UndispatchedCoroutine undispatchedCompletion$iv$iv = undispatchedCoroutine;
                    try {
                        try {
                            this.continuation.resumeWith(result);
                            Unit unit = Unit.INSTANCE;
    ...
    public final boolean resumeCancelled(Object state) {
        ...
        if (job != null && !job.isActive()) {
            ...
            Result.Companion companion = Result.INSTANCE;
            resumeWith(Result.m187constructorimpl(ResultKt.createFailure(cause)));
            return true;
        }
        return false;
    }
