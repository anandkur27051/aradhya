    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        while (true) {
            ...
            if (!(state instanceof CompletedContinuation)) {
                if (C0119xc40028dd.m6m(_state$FU, this, state, new CompletedContinuation(state, null, null, null, cause, 14, null))) {
                    return;
                }
            } else {
    ...
    public void invokeOnCancellation(Function1<? super Throwable, Unit> handler) {
        ...
        while (true) {
            ...
            if (state instanceof Active) {
                if (C0119xc40028dd.m6m(_state$FU, this, state, cancelHandler)) {
                    return;
                }
                ...
                if (state instanceof CompletedContinuation) {
                    ...
                    if (C0119xc40028dd.m6m(_state$FU, this, state, update2)) {
                        return;
                    }
                }
            }
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
        while (true) {
            ...
            if (state instanceof NotCompleted) {
                ...
                if (idempotent3 != null && ((CompletedContinuation) state).idempotentResume == idempotent3) {
