...
public final class TimeoutKt {
    ...
    public static final <T> Object m1675withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1667toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
    ...
    */
                    ...
                    case 0:
                        ...
                        if (j > 0) {
                            ...
                            try {
                                ...
                                ?? r6 = (T) new TimeoutCoroutine(j, timeoutKt$withTimeoutOrNull$1);
    ...
    public static final <T> Object m1676withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1667toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
