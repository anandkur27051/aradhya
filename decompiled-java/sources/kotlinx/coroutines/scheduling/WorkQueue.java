...
public final class WorkQueue {
    ...
    public final long tryStealBlockingFrom(WorkQueue victim) {
        ...
        for (int start = victim.consumerIndex; start != end; start++) {
            ...
            if (value != null) {
                ...
                if ($this$isBlocking$iv != null && AtomicIntrinsicsKt$$ExternalSyntheticBackportWithForwarding0.m138m(buffer, index, value, null)) {
    ...
    private final long tryStealLastScheduled(WorkQueue victim, boolean blockingOnly) {
        ...
        } while (!C0119xc40028dd.m6m(lastScheduledTask$FU, victim, lastScheduled, null));
