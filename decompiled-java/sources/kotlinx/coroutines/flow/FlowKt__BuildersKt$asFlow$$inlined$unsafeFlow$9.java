...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$9 implements Flow<Integer> {
    ...
    @DebugMetadata(m140c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$9", m141f = "Builders.kt", m142i = {0}, m143l = {115}, m144m = "collect", m145n = {"$this$asFlow_u24lambda_u2d17"}, m146s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$9$1 */
    /* loaded from: classes.dex */
    public static final class C08311 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C08311(Continuation continuation) {
            super(continuation);
        }
            ...
            if ((c08311.label & Integer.MIN_VALUE) != 0) {
                ...
                switch (c08311.label) {
                    case 0:
                        ...
                        break;
                    case 1:
                        it = (Iterator) c08311.L$1;
                        FlowCollector flowCollector3 = (FlowCollector) c08311.L$0;
                        ResultKt.throwOnFailure(obj);
                ...
                while (it.hasNext()) {
                    ...
                    c08311.L$0 = flowCollector2;
                    c08311.L$1 = it;
                    c08311.label = 1;
                    if (flowCollector2.emit(boxInt, c08311) == coroutine_suspended) {
