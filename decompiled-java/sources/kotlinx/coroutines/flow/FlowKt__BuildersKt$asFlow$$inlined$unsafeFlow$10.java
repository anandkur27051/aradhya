...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10 implements Flow<Long> {
    ...
    @DebugMetadata(m140c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10", m141f = "Builders.kt", m142i = {0}, m143l = {115}, m144m = "collect", m145n = {"$this$asFlow_u24lambda_u2d19"}, m146s = {"L$0"})
            ...
            if ((c08231.label & Integer.MIN_VALUE) != 0) {
                ...
                switch (c08231.label) {
                    case 0:
                        ...
                        break;
                    case 1:
                        it = (Iterator) c08231.L$1;
                        FlowCollector flowCollector3 = (FlowCollector) c08231.L$0;
                        ResultKt.throwOnFailure(obj);
                ...
                while (it.hasNext()) {
                    ...
                    c08231.L$0 = flowCollector2;
                    c08231.L$1 = it;
                    c08231.label = 1;
                    if (flowCollector2.emit(boxLong, c08231) == coroutine_suspended) {
