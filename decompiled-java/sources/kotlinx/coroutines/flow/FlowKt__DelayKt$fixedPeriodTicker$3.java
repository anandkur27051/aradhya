...
@Metadata(m129d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00010\u0002H\u008a@"}, m130d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;"}, m131k = 3, m132mv = {1, 6, 0}, m134xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m140c = "kotlinx.coroutines.flow.FlowKt__DelayKt$fixedPeriodTicker$3", m141f = "Delay.kt", m142i = {0, 1, 2}, m143l = {314, 316, 317}, m144m = "invokeSuspend", m145n = {"$this$produce", "$this$produce", "$this$produce"}, m146s = {"L$0", "L$0", "L$0"})
