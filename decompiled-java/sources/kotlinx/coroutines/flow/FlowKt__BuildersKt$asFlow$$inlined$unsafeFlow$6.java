...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6<T> implements Flow<T> {
    ...
    @DebugMetadata(m140c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6", m141f = "Builders.kt", m142i = {0, 0}, m143l = {115}, m144m = "collect", m145n = {"$this$asFlow_u24lambda_u2d11", "$this$forEach$iv"}, m146s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6$1 */
    /* loaded from: classes.dex */
    public static final class C08281 extends ContinuationImpl {
        int I$0;
        int I$1;
        Object L$0;
        Object L$1;
        ...
        public C08281(Continuation continuation) {
            super(continuation);
        }
                ...
                switch (c08281.label) {
                    case 0:
                        ...
                        if (i < length) {
                            ...
                            c08281.L$0 = flowCollector2;
                            c08281.L$1 = objArr;
                            c08281.I$0 = i;
                            c08281.I$1 = length;
                            c08281.label = 1;
                            if (flowCollector2.emit(obj2, c08281) == coroutine_suspended) {
                    ...
                    case 1:
                        length = c08281.I$1;
                        i = c08281.I$0;
                        objArr = (Object[]) c08281.L$1;
                        FlowCollector flowCollector4 = (FlowCollector) c08281.L$0;
                        ResultKt.throwOnFailure(obj);
