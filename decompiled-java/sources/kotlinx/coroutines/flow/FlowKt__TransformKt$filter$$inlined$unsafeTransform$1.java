...
public final class FlowKt__TransformKt$filter$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    /* loaded from: classes.dex */
    public static final class C08542<T> implements FlowCollector {
        final /* synthetic */ Function2 $predicate$inlined;
        final /* synthetic */ FlowCollector $this_unsafeFlow;

        /* compiled from: Emitters.kt */
        @Metadata(m131k = 3, m132mv = {1, 6, 0}, m134xi = 176)
        @DebugMetadata(m140c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filter$$inlined$unsafeTransform$1$2", m141f = "Transform.kt", m142i = {0, 0}, m143l = {223, 223}, m144m = "emit", m145n = {"value", "$this$filter_u24lambda_u2d0"}, m146s = {"L$0", "L$1"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C08542.this.emit(null, this);
            }
        }

        public C08542(FlowCollector flowCollector, Function2 function2) {
                ...
                if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    switch (anonymousClass1.label) {
                        case 0:
                            ...
                            anonymousClass1.L$1 = $this$filter_u24lambda_u2d0;
                            ...
                            if (((Boolean) invoke).booleanValue()) {
                                ...
                                if ($this$filter_u24lambda_u2d0.emit(t2, anonymousClass1) == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                            }
                            return Unit.INSTANCE;
                        case 1:
                            FlowCollector $this$filter_u24lambda_u2d02 = (FlowCollector) anonymousClass1.L$1;
                            Object obj = anonymousClass1.L$0;
                            ResultKt.throwOnFailure($result);
                            t2 = obj;
                            $this$filter_u24lambda_u2d0 = $this$filter_u24lambda_u2d02;
                            invoke = $result;
                            if (((Boolean) invoke).booleanValue()) {
                            }
                            return Unit.INSTANCE;
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C08542(collector, this.$predicate$inlined), $completion);
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        this.$this_unsafeTransform$inlined.collect(new C08542(collector, this.$predicate$inlined), $completion);
        return Unit.INSTANCE;
    }
}
