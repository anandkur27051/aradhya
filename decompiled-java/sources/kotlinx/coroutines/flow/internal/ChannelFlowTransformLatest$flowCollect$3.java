...
@Metadata(m129d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\u00020\u0004H\u008a@"}, m130d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/CoroutineScope;"}, m131k = 3, m132mv = {1, 6, 0}, m134xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m140c = "kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3", m141f = "Merge.kt", m142i = {}, m143l = {27}, m144m = "invokeSuspend", m145n = {}, m146s = {})
...
final class ChannelFlowTransformLatest$flowCollect$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (this.this$0.flow.collect(new C08841(previousFlow, $this$coroutineScope, this.this$0, this.$collector), this) != coroutine_suspended) {
                    break;
                } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: Merge.kt */
    @Metadata(m129d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\u0006\u0010\u0004\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m130d2 = {"<anonymous>", "", "T", "R", "value", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m131k = 3, m132mv = {1, 6, 0}, m134xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3$1 */
    /* loaded from: classes.dex */
    public static final class C08841<T> implements FlowCollector {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C08841(Ref.ObjectRef<Job> objectRef, CoroutineScope coroutineScope, ChannelFlowTransformLatest<T, R> channelFlowTransformLatest, FlowCollector<? super R> flowCollector) {
        ...
        */
                ...
                if ((channelFlowTransformLatest$flowCollect$3$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    switch (channelFlowTransformLatest$flowCollect$3$1$emit$1.label) {
                        case 0:
                            ...
                            c08841 = this;
                            Job job = c08841.$previousFlow.element;
                            if (job != null) {
                                job.cancel((CancellationException) new ChildCancelledException());
                                channelFlowTransformLatest$flowCollect$3$1$emit$1.L$0 = c08841;
                            ...
                            Ref.ObjectRef<Job> objectRef = c08841.$previousFlow;
                            launch$default = BuildersKt__Builders_commonKt.launch$default(c08841.$$this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new AnonymousClass2(c08841.this$0, c08841.$collector, t, null), 1, null);
                            objectRef.element = (T) launch$default;
                            return Unit.INSTANCE;
                        case 1:
                            Object obj2 = channelFlowTransformLatest$flowCollect$3$1$emit$1.L$1;
                            c08841 = (C08841) channelFlowTransformLatest$flowCollect$3$1$emit$1.L$0;
                            ResultKt.throwOnFailure(obj);
                            t2 = obj2;
                            t = t2;
                            Ref.ObjectRef<Job> objectRef2 = c08841.$previousFlow;
                            launch$default = BuildersKt__Builders_commonKt.launch$default(c08841.$$this$coroutineScope, null, CoroutineStart.UNDISPATCHED, new AnonymousClass2(c08841.this$0, c08841.$collector, t, null), 1, null);
        ...
        /* compiled from: Merge.kt */
        @Metadata(m129d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\u00020\u0004H\u008a@"}, m130d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/CoroutineScope;"}, m131k = 3, m132mv = {1, 6, 0}, m134xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        @DebugMetadata(m140c = "kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3$1$2", m141f = "Merge.kt", m142i = {}, m143l = {34}, m144m = "invokeSuspend", m145n = {}, m146s = {})
