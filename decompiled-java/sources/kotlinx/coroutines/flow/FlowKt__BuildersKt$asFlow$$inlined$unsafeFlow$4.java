...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4<T> implements Flow<T> {
    ...
    @DebugMetadata(m140c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4", m141f = "Builders.kt", m142i = {0}, m143l = {115}, m144m = "collect", m145n = {"$this$asFlow_u24lambda_u2d5"}, m146s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4$1 */
    /* loaded from: classes.dex */
    public static final class C08261 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C08261(Continuation continuation) {
            super(continuation);
        }
            ...
            if ((c08261.label & Integer.MIN_VALUE) != 0) {
                ...
                switch (c08261.label) {
                    case 0:
                        ...
                        break;
                    case 1:
                        it = (Iterator) c08261.L$1;
                        FlowCollector flowCollector3 = (FlowCollector) c08261.L$0;
                        ResultKt.throwOnFailure(obj);
                ...
                while (it.hasNext()) {
                    Object next = it.next();
                    c08261.L$0 = flowCollector2;
                    c08261.L$1 = it;
                    c08261.label = 1;
                    if (flowCollector2.emit(next, c08261) == coroutine_suspended) {
