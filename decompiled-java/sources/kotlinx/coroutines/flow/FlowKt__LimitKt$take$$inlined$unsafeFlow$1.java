...
public final class FlowKt__LimitKt$take$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m140c = "kotlinx.coroutines.flow.FlowKt__LimitKt$take$$inlined$unsafeFlow$1", m141f = "Limit.kt", m142i = {0}, m143l = {115}, m144m = "collect", m145n = {"$this$take_u24lambda_u2d4"}, m146s = {"L$0"})
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C08421) {
            c08421 = (C08421) continuation;
            if ((c08421.label & Integer.MIN_VALUE) != 0) {
                c08421.label -= Integer.MIN_VALUE;
                Object $result = c08421.result;
                ...
                switch (c08421.label) {
                    case 0:
                        ...
                        return flow.collect(flowKt__LimitKt$take$2$1, c08421) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    case 1:
                        $this$take_u24lambda_u2d4 = (FlowCollector) c08421.L$0;
                        try {
                            ResultKt.throwOnFailure($result);
        ...
        c08421 = new C08421(continuation);
        Object $result2 = c08421.result;
