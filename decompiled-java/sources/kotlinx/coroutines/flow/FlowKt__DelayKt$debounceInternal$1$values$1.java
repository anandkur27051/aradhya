...
@DebugMetadata(m140c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$values$1", m141f = "Delay.kt", m142i = {}, m143l = {211}, m144m = "invokeSuspend", m145n = {}, m146s = {})
...
final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes.dex */
    public static final class C08331<T> implements FlowCollector {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C08331(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (this.$this_debounceInternal.collect(new C08331($this$produce), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
