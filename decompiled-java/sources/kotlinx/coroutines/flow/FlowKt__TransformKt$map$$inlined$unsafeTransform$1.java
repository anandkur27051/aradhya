...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    /* loaded from: classes.dex */
    public static final class C08612<T> implements FlowCollector {
        final /* synthetic */ FlowCollector $this_unsafeFlow;
        final /* synthetic */ Function2 $transform$inlined;

        /* compiled from: Emitters.kt */
        @Metadata(m131k = 3, m132mv = {1, 6, 0}, m134xi = 176)
        @DebugMetadata(m140c = "kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2", m141f = "Transform.kt", m142i = {}, m143l = {223, 223}, m144m = "emit", m145n = {}, m146s = {})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C08612.this.emit(null, this);
            }
        }

        public C08612(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C08612(collector, this.$transform$inlined$1), $completion);
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        this.$this_unsafeTransform$inlined.collect(new C08612(collector, this.$transform$inlined$1), $completion);
        return Unit.INSTANCE;
    }
}
