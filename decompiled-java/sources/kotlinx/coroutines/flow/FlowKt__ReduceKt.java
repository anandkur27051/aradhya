            ...
            if ((flowKt__ReduceKt$firstOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                switch (flowKt__ReduceKt$firstOrNull$1.label) {
                    case 0:
                        ...
                        return flow.collect(flowCollector2, flowKt__ReduceKt$firstOrNull$1) == coroutine_suspended ? coroutine_suspended : result.element;
                    case 1:
