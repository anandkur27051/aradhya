...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m140c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", m141f = "Reduce.kt", m142i = {0, 0}, m143l = {142}, m144m = "emit", m145n = {"this", "it"}, m146s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2$1 */
    /* loaded from: classes.dex */
    public static final class C08481 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
            ...
            if ((c08481.label & Integer.MIN_VALUE) != 0) {
                ...
                switch (c08481.label) {
                    case 0:
                        ...
                        c08481.L$0 = flowKt__ReduceKt$first$$inlined$collectWhile$2;
                        c08481.L$1 = t;
                        c08481.label = 1;
                        invoke = function2.invoke(t, c08481);
                    ...
                    case 1:
                        t2 = (T) c08481.L$1;
                        flowKt__ReduceKt$first$$inlined$collectWhile$2 = (FlowKt__ReduceKt$first$$inlined$collectWhile$2) c08481.L$0;
                        ResultKt.throwOnFailure(obj);
                        invoke = obj;
                        break;
                    default:
