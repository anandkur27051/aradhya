                ...
                switch (flowKt__EmittersKt$invokeSafely$1.label) {
                    case 0:
                        ...
                        try {
                            ...
                            return function3.invoke(flowCollector, cause, flowKt__EmittersKt$invokeSafely$1) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        } catch (Throwable th) {
                            e = th;
                            cause2 = cause;
                            if (cause2 != null) {
