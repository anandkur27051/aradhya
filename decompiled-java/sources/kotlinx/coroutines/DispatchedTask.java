            ...
            if (oldValue$iv != ThreadContextKt.NO_THREAD_ELEMENTS) {
                try {
                    ...
                    try {
                        ...
                        result = Result.m187constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th2) {
                        th = th2;
                        Result.Companion companion2 = Result.INSTANCE;
                        result = Result.m187constructorimpl(ResultKt.createFailure(th));
                        handleFatalException(fatalException, Result.m190exceptionOrNullimpl(result));
                    }
                    handleFatalException(fatalException, Result.m190exceptionOrNullimpl(result));
                }
            } else {
                    ...
                    try {
                        if (job == null || job.isActive()) {
                            ...
                            if (exception != null) {
                                ...
                                continuation.resumeWith(Result.m187constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                            }
                        } else {
                            ...
                            if (DebugKt.getRECOVER_STACK_TRACES()) {
                                ...
                                try {
                                    if (continuation instanceof CoroutineStackFrame) {
                                        ...
                                        continuation.resumeWith(Result.m187constructorimpl(ResultKt.createFailure(cancellationException)));
                                    }
                                } catch (Throwable th4) {
                                    th = th4;
