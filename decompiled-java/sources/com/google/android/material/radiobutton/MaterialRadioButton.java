...
public class MaterialRadioButton extends AppCompatRadioButton {
    private static final int DEF_STYLE_RES = C0489R.style.Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    public MaterialRadioButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0489R.attr.radioButtonStyle);
    }

    public MaterialRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(MaterialThemeOverlay.wrap(context, attrs, defStyleAttr, DEF_STYLE_RES), attrs, defStyleAttr);
        Context context2 = getContext();
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0489R.styleable.MaterialRadioButton, defStyleAttr, DEF_STYLE_RES, new int[0]);
        if (attributes.hasValue(C0489R.styleable.MaterialRadioButton_buttonTint)) {
            CompoundButtonCompat.setButtonTintList(this, MaterialResources.getColorStateList(context2, attributes, C0489R.styleable.MaterialRadioButton_buttonTint));
        }
        this.useMaterialThemeColors = attributes.getBoolean(C0489R.styleable.MaterialRadioButton_useMaterialThemeColors, false);
        attributes.recycle();
    }
