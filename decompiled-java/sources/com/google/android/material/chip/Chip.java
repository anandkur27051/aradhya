...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private static final int DEF_STYLE_RES = C0489R.style.Widget_MaterialComponents_Chip_Action;
    ...
    public Chip(Context context, AttributeSet attrs) {
        this(context, attrs, C0489R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0489R.styleable.Chip, defStyleAttr, DEF_STYLE_RES, new int[0]);
        boolean hasShapeAppearanceAttribute = a.hasValue(C0489R.styleable.Chip_shapeAppearance);
        a.recycle();
        ...
        super.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.google.android.material.chip.Chip$$ExternalSyntheticLambda0
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                Chip.this.m179lambda$new$0$comgoogleandroidmaterialchipChip(compoundButton, z);
            }
        });
    }
    ...
    public /* synthetic */ void m179lambda$new$0$comgoogleandroidmaterialchipChip(CompoundButton buttonView, boolean isChecked) {
    ...
    private void initMinTouchTarget(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0489R.styleable.Chip, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = a.getBoolean(C0489R.styleable.Chip_ensureMinTouchTargetSize, false);
        float defaultMinTouchTargetSize = (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48));
        this.minTouchTargetSize = (int) Math.ceil(a.getDimension(C0489R.styleable.Chip_chipMinTouchTargetSize, defaultMinTouchTargetSize));
        a.recycle();
    }
        ...
        protected void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfoCompat node) {
            if (virtualViewId == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    node.setContentDescription(Chip.this.getContext().getString(C0489R.string.mtrl_chip_close_icon_content_description, TextUtils.isEmpty(chipText) ? "" : chipText).trim());
                }
