...
public class ChipGroup extends FlowLayout {
    private static final int DEF_STYLE_RES = C0489R.style.Widget_MaterialComponents_ChipGroup;
    ...
    public ChipGroup(Context context, AttributeSet attrs) {
        this(context, attrs, C0489R.attr.chipGroupStyle);
    }
    ...
    public ChipGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0489R.styleable.ChipGroup, defStyleAttr, DEF_STYLE_RES, new int[0]);
        int chipSpacing = a.getDimensionPixelOffset(C0489R.styleable.ChipGroup_chipSpacing, 0);
        setChipSpacingHorizontal(a.getDimensionPixelOffset(C0489R.styleable.ChipGroup_chipSpacingHorizontal, chipSpacing));
        setChipSpacingVertical(a.getDimensionPixelOffset(C0489R.styleable.ChipGroup_chipSpacingVertical, chipSpacing));
        setSingleLine(a.getBoolean(C0489R.styleable.ChipGroup_singleLine, false));
        setSingleSelection(a.getBoolean(C0489R.styleable.ChipGroup_singleSelection, false));
        setSelectionRequired(a.getBoolean(C0489R.styleable.ChipGroup_selectionRequired, false));
        this.defaultCheckedId = a.getResourceId(C0489R.styleable.ChipGroup_checkedChip, -1);
        a.recycle();
