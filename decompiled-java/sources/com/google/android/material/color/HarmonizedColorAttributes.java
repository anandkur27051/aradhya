...
public final class HarmonizedColorAttributes {
    private static final int[] HARMONIZED_MATERIAL_ATTRIBUTES = {C0489R.attr.colorError, C0489R.attr.colorOnError, C0489R.attr.colorErrorContainer, C0489R.attr.colorOnErrorContainer};
    ...
    public static HarmonizedColorAttributes createMaterialDefaults() {
        return create(HARMONIZED_MATERIAL_ATTRIBUTES, C0489R.style.ThemeOverlay_Material3_HarmonizedColors);
    }
