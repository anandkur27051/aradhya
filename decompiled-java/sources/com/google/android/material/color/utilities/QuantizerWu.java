...
public final class QuantizerWu implements Quantizer {
    ...
    double variance(Box cube) {
        ...
        double xx = ((((((this.moments[getIndex(cube.f184r1, cube.f182g1, cube.f180b1)] - this.moments[getIndex(cube.f184r1, cube.f182g1, cube.f179b0)]) - this.moments[getIndex(cube.f184r1, cube.f181g0, cube.f180b1)]) + this.moments[getIndex(cube.f184r1, cube.f181g0, cube.f179b0)]) - this.moments[getIndex(cube.f183r0, cube.f182g1, cube.f180b1)]) + this.moments[getIndex(cube.f183r0, cube.f182g1, cube.f179b0)]) + this.moments[getIndex(cube.f183r0, cube.f181g0, cube.f180b1)]) - this.moments[getIndex(cube.f183r0, cube.f181g0, cube.f179b0)];
    ...
    Boolean cut(Box one, Box two) {
        ...
        MaximizeResult maxRResult = maximize(one, Direction.RED, one.f183r0 + 1, one.f184r1, wholeR, wholeG, wholeB, wholeW);
        MaximizeResult maxGResult = maximize(one, Direction.GREEN, one.f181g0 + 1, one.f182g1, wholeR, wholeG, wholeB, wholeW);
        MaximizeResult maxBResult = maximize(one, Direction.BLUE, one.f179b0 + 1, one.f180b1, wholeR, wholeG, wholeB, wholeW);
        ...
        two.f184r1 = one.f184r1;
        two.f182g1 = one.f182g1;
        two.f180b1 = one.f180b1;
        switch (cutDirection2) {
            case RED:
                one.f184r1 = maxRResult.cutLocation;
                two.f183r0 = one.f184r1;
                two.f181g0 = one.f181g0;
                two.f179b0 = one.f179b0;
                break;
            case GREEN:
                one.f182g1 = maxGResult.cutLocation;
                two.f183r0 = one.f183r0;
                two.f181g0 = one.f182g1;
                two.f179b0 = one.f179b0;
                break;
            case BLUE:
                one.f180b1 = maxBResult.cutLocation;
                two.f183r0 = one.f183r0;
                two.f181g0 = one.f181g0;
                two.f179b0 = one.f180b1;
                break;
        }
        one.vol = (one.f180b1 - one.f179b0) * (one.f182g1 - one.f181g0) * (one.f184r1 - one.f183r0);
        two.vol = (two.f180b1 - two.f179b0) * (two.f182g1 - two.f181g0) * (two.f184r1 - two.f183r0);
    ...
    static int volume(Box cube, int[] moment) {
        return ((((((moment[getIndex(cube.f184r1, cube.f182g1, cube.f180b1)] - moment[getIndex(cube.f184r1, cube.f182g1, cube.f179b0)]) - moment[getIndex(cube.f184r1, cube.f181g0, cube.f180b1)]) + moment[getIndex(cube.f184r1, cube.f181g0, cube.f179b0)]) - moment[getIndex(cube.f183r0, cube.f182g1, cube.f180b1)]) + moment[getIndex(cube.f183r0, cube.f182g1, cube.f179b0)]) + moment[getIndex(cube.f183r0, cube.f181g0, cube.f180b1)]) - moment[getIndex(cube.f183r0, cube.f181g0, cube.f179b0)];
    }

    static int bottom(Box cube, Direction direction, int[] moment) {
        switch (direction) {
            case RED:
                return (((-moment[getIndex(cube.f183r0, cube.f182g1, cube.f180b1)]) + moment[getIndex(cube.f183r0, cube.f182g1, cube.f179b0)]) + moment[getIndex(cube.f183r0, cube.f181g0, cube.f180b1)]) - moment[getIndex(cube.f183r0, cube.f181g0, cube.f179b0)];
            case GREEN:
                return (((-moment[getIndex(cube.f184r1, cube.f181g0, cube.f180b1)]) + moment[getIndex(cube.f184r1, cube.f181g0, cube.f179b0)]) + moment[getIndex(cube.f183r0, cube.f181g0, cube.f180b1)]) - moment[getIndex(cube.f183r0, cube.f181g0, cube.f179b0)];
            case BLUE:
                return (((-moment[getIndex(cube.f184r1, cube.f182g1, cube.f179b0)]) + moment[getIndex(cube.f184r1, cube.f181g0, cube.f179b0)]) + moment[getIndex(cube.f183r0, cube.f182g1, cube.f179b0)]) - moment[getIndex(cube.f183r0, cube.f181g0, cube.f179b0)];
            default:
    ...
    static int top(Box cube, Direction direction, int position, int[] moment) {
        switch (direction) {
            case RED:
                return ((moment[getIndex(position, cube.f182g1, cube.f180b1)] - moment[getIndex(position, cube.f182g1, cube.f179b0)]) - moment[getIndex(position, cube.f181g0, cube.f180b1)]) + moment[getIndex(position, cube.f181g0, cube.f179b0)];
            case GREEN:
                return ((moment[getIndex(cube.f184r1, position, cube.f180b1)] - moment[getIndex(cube.f184r1, position, cube.f179b0)]) - moment[getIndex(cube.f183r0, position, cube.f180b1)]) + moment[getIndex(cube.f183r0, position, cube.f179b0)];
            case BLUE:
                return ((moment[getIndex(cube.f184r1, cube.f182g1, position)] - moment[getIndex(cube.f184r1, cube.f181g0, position)]) - moment[getIndex(cube.f183r0, cube.f182g1, position)]) + moment[getIndex(cube.f183r0, cube.f181g0, position)];
            default:
                throw new IllegalArgumentException("unexpected direction " + direction);
        }
    }
