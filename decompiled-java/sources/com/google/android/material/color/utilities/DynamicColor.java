...
public final class DynamicColor {
    ...
    public static DynamicColor fromArgb(final int argb, Function<DynamicScheme, Double> tone) {
        return fromPalette(new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda1
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
    ...
    public static DynamicColor fromArgb(final int argb, Function<DynamicScheme, Double> tone, Function<DynamicScheme, DynamicColor> background, Function<DynamicScheme, ToneDeltaConstraint> toneDeltaConstraint) {
        return fromPalette(new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda7
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                TonalPalette fromInt;
                fromInt = TonalPalette.fromInt(argb);
    ...
    public static DynamicColor fromPalette(final Function<DynamicScheme, TonalPalette> palette, final Function<DynamicScheme, Double> tone, final Function<DynamicScheme, DynamicColor> background, final Function<DynamicScheme, ToneDeltaConstraint> toneDeltaConstraint) {
        return new DynamicColor(new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda8
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double valueOf;
        ...
        }, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda9
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double valueOf;
        ...
        }, tone, null, background, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda10
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double valueOf;
        ...
        }, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda11
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double valueOf;
    ...
    public double getTone(final DynamicScheme scheme) {
        ...
        if (bgDynamicColor == null) {
            ...
            double doubleValue = this.tone.apply(scheme).doubleValue();
            double minRatio3 = bgDynamicColor.tone.apply(scheme).doubleValue();
            double standardRatio = Contrast.ratioOfTones(doubleValue, minRatio3);
            if (decreasingContrast) {
                boolean bgHasBg2 = bgHasBg;
                double minContrastRatio = Contrast.ratioOfTones(this.toneMinContrast.apply(scheme).doubleValue(), bgDynamicColor.toneMinContrast.apply(scheme).doubleValue());
                minRatio = bgHasBg2 ? minContrastRatio : 1.0d;
                minRatio2 = standardRatio;
            } else {
                boolean bgHasBg3 = bgHasBg;
                ...
                minRatio = bgHasBg3 ? Math.min(maxContrastRatio, standardRatio) : 1.0d;
                minRatio2 = bgHasBg3 ? Math.max(maxContrastRatio, standardRatio) : 21.0d;
            }
        }
        final double finalMinRatio = minRatio;
        final double finalMaxRatio = minRatio2;
        final double finalAnswer = endTone;
        double answer3 = calculateDynamicTone(scheme, this.tone, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda2
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double valueOf;
        ...
        }, new BiFunction() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda3
        ...
        }, this.toneDeltaConstraint, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda5
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double valueOf;
    ...
    public static double toneMinContrastDefault(final Function<DynamicScheme, Double> tone, final Function<DynamicScheme, DynamicColor> background, final DynamicScheme scheme, Function<DynamicScheme, ToneDeltaConstraint> toneDeltaConstraint) {
        return calculateDynamicTone(scheme, tone, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda16
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double apply;
        ...
        }, new BiFunction() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda17
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
                return DynamicColor.lambda$toneMinContrastDefault$15(tone, scheme, background, (Double) obj, (Double) obj2);
            }
        }, background, toneDeltaConstraint, null, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda18
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
    ...
    public static double toneMaxContrastDefault(Function<DynamicScheme, Double> tone, final Function<DynamicScheme, DynamicColor> background, final DynamicScheme scheme, Function<DynamicScheme, ToneDeltaConstraint> toneDeltaConstraint) {
        return calculateDynamicTone(scheme, tone, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda14
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Double apply;
        ...
        }, new BiFunction() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda15
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
