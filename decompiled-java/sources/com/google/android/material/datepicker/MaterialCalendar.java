...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    /* JADX WARN: Type inference failed for: r0v17, types: [android.content.Context, androidx.recyclerview.widget.RecyclerView$LayoutManager, android.view.ContextThemeWrapper, com.google.android.material.datepicker.MaterialCalendar$2] */
    ...
    /* JADX WARN: Type inference failed for: r7v3, types: [android.view.View, int] */
    /* JADX WARN: Type inference failed for: r7v7, types: [android.view.View, int] */
    @Override // androidx.fragment.app.Fragment
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(r0)) {
            int layout2 = C0489R.layout.mtrl_calendar_vertical;
            layout = layout2;
            orientation = 1;
        } else {
            int layout3 = C0489R.layout.mtrl_calendar_horizontal;
            layout = layout3;
            orientation = 0;
        }
        View root = themedInflater.inflate(layout, viewGroup, false);
        root.setMinimumHeight(getDialogPickerHeight(requireContext()));
        GridView daysHeader = (GridView) root.findViewById(C0489R.id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) root.findViewById(C0489R.id.mtrl_calendar_months);
        final int i = orientation;
        ?? r02 = new SmoothCalendarLayoutManager(getContext(), orientation, false) { // from class: com.google.android.material.datepicker.MaterialCalendar.2
        ...
        this.recyclerView.setLayoutManager(r02);
        this.recyclerView.setTag(MONTHS_VIEW_GROUP_TAG);
        MonthsPagerAdapter monthsPagerAdapter = new MonthsPagerAdapter(r02, this.dateSelector, this.calendarConstraints, this.dayViewDecorator, new OnDayClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.3
            /* JADX WARN: Multi-variable type inference failed */
        ...
        int columns = r02.getResources().getInteger(C0489R.integer.mtrl_calendar_year_selector_span);
        ?? r7 = C0489R.id.mtrl_calendar_year_selector_frame;
        this.yearSelector = (RecyclerView) r7.findViewById(r7);
        ...
        ?? r72 = C0489R.id.month_navigation_fragment_toggle;
        View root2 = r72.findViewById(r72);
        if (root2 != null) {
        ...
        recyclerView.scrollToPosition(monthsPagerAdapter.getPosition(this.current));
    ...
    public static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C0489R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View root, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton monthDropSelect = (MaterialButton) root.findViewById(C0489R.id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(monthDropSelect, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                MaterialCalendar materialCalendar = MaterialCalendar.this;
                if (visibility == 0) {
                    string = materialCalendar.getString(C0489R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    string = materialCalendar.getString(C0489R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(string);
            }
        });
        this.monthPrev = root.findViewById(C0489R.id.month_navigation_previous);
        this.monthPrev.setTag(NAVIGATION_PREV_TAG);
        this.monthNext = root.findViewById(C0489R.id.month_navigation_next);
        this.monthNext.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = root.findViewById(C0489R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = root.findViewById(C0489R.id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        int navigationHeight = resources.getDimensionPixelSize(C0489R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C0489R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C0489R.dimen.mtrl_calendar_navigation_bottom_padding);
        int daysOfWeekHeight = resources.getDimensionPixelSize(C0489R.dimen.mtrl_calendar_days_of_week_height);
        int calendarHeight = (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C0489R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C0489R.dimen.mtrl_calendar_month_vertical_padding));
        int calendarPadding = resources.getDimensionPixelOffset(C0489R.dimen.mtrl_calendar_bottom_padding);
