...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setIconSize(context.getResources().getDimensionPixelSize(C0489R.dimen.design_navigation_icon_size));
        this.textView = (CheckedTextView) findViewById(C0489R.id.design_menu_item_text);
    ...
    private void setActionView(View actionView) {
        if (actionView != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C0489R.id.design_menu_item_action_area_stub)).inflate();
            }
            this.actionArea.removeAllViews();
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (getContext().getTheme().resolveAttribute(C0024R.attr.colorControlHighlight, value, true)) {
    ...
    public void setIcon(Drawable icon) {
        if (icon != null) {
            ...
            if (this.emptyDrawable == null) {
                this.emptyDrawable = ResourcesCompat.getDrawable(getResources(), C0489R.drawable.navigation_empty_icon, getContext().getTheme());
                if (this.emptyDrawable != null) {
