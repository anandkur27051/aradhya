...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(Context context, AttributeSet attrs) {
        TypedArray array = context.getTheme().obtainStyledAttributes(attrs, C0489R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = array.getDimensionPixelSize(C0489R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = array.getDimensionPixelSize(C0489R.styleable.FlowLayout_itemSpacing, 0);
        array.recycle();
    }
    ...
    protected void onLayout(boolean sizeChanged, int left, int top, int right, int bottom) {
        ...
        while (i3 < getChildCount()) {
            ...
            if (child.getVisibility() == 8) {
                child.setTag(C0489R.id.row_index_key, -1);
                i = i2;
            } else {
                ViewGroup.LayoutParams lp = child.getLayoutParams();
                int startMargin = 0;
                ...
                i = i2;
                child.setTag(C0489R.id.row_index_key, Integer.valueOf(this.rowCount - 1));
    ...
    public int getRowIndex(View child) {
        Object index = child.getTag(C0489R.id.row_index_key);
