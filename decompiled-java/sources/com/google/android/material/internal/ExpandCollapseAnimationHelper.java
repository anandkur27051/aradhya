...
public class ExpandCollapseAnimationHelper {
    ...
    private Animator getExpandCollapseAnimator(boolean expand) {
        ...
        animator.setInterpolator(ReversableAnimatedValueInterpolator.m91of(expand, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return animator;
    }
    ...
    public /* synthetic */ void m90xeb41e2ac(Rect bounds, ValueAnimator valueAnimator) {
    ...
    private Animator getExpandedViewChildrenAlphaAnimator(boolean expand) {
        ...
        animator.setDuration(this.duration);
        animator.setInterpolator(ReversableAnimatedValueInterpolator.m91of(expand, AnimationUtils.LINEAR_INTERPOLATOR));
        return animator;
    }
