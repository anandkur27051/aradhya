...
public class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    public /* synthetic */ void m113xfc81bd94(View view) {
    ...
    public /* synthetic */ void m114x7ae2c173(View view, boolean hasFocus) {
    ...
    public ClearTextEndIconDelegate(EndCompoundLayout endLayout) {
        ...
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(endLayout.getContext(), C0489R.attr.motionDurationShort3, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endLayout.getContext(), C0489R.attr.motionDurationShort3, DEFAULT_ANIMATION_SCALE_DURATION);
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(endLayout.getContext(), C0489R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(endLayout.getContext(), C0489R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    }
    ...
    public /* synthetic */ void m115x26d8c5f4() {
        animateIcon(true);
    }
    ...
    public int getIconDrawableResId() {
        return C0489R.drawable.mtrl_ic_cancel;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.android.material.textfield.EndIconDelegate
    public int getIconContentDescriptionResId() {
        return C0489R.string.clear_text_end_icon_content_description;
    }
    ...
    public /* synthetic */ void m111xa5c23ba8(ValueAnimator animation) {
    ...
    public /* synthetic */ void m112x3819711b(ValueAnimator animation) {
