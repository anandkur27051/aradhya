...
public class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    public /* synthetic */ void m123x4cc26475(View view) {
    ...
    public PasswordToggleEndIconDelegate(EndCompoundLayout endLayout, int overrideIconResId) {
        super(endLayout);
        this.iconResId = C0489R.drawable.design_password_eye;
    ...
    public int getIconContentDescriptionResId() {
        return C0489R.string.password_toggle_content_description;
    }
