...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0489R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0489R.styleable.MaterialAutoCompleteTextView, defStyleAttr, C0489R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (attributes.hasValue(C0489R.styleable.MaterialAutoCompleteTextView_android_inputType)) {
            int inputType = attributes.getInt(C0489R.styleable.MaterialAutoCompleteTextView_android_inputType, 0);
            if (inputType == 0) {
                setKeyListener(null);
            }
        }
        int inputType2 = C0489R.styleable.MaterialAutoCompleteTextView_simpleItemLayout;
        this.simpleItemLayout = attributes.getResourceId(inputType2, C0489R.layout.mtrl_auto_complete_simple_item);
        this.popupElevation = attributes.getDimensionPixelOffset(C0489R.styleable.MaterialAutoCompleteTextView_android_popupElevation, C0489R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        if (attributes.hasValue(C0489R.styleable.MaterialAutoCompleteTextView_dropDownBackgroundTint)) {
            this.dropDownBackgroundTint = ColorStateList.valueOf(attributes.getColor(C0489R.styleable.MaterialAutoCompleteTextView_dropDownBackgroundTint, 0));
        }
        this.simpleItemSelectedColor = attributes.getColor(C0489R.styleable.MaterialAutoCompleteTextView_simpleItemSelectedColor, 0);
        this.simpleItemSelectedRippleColor = MaterialResources.getColorStateList(context2, attributes, C0489R.styleable.MaterialAutoCompleteTextView_simpleItemSelectedRippleColor);
        ...
        if (attributes.hasValue(C0489R.styleable.MaterialAutoCompleteTextView_simpleItems)) {
            setSimpleItems(attributes.getResourceId(C0489R.styleable.MaterialAutoCompleteTextView_simpleItems, 0));
        }
        attributes.recycle();
    }
    ...
    public class MaterialArrayAdapter<T> extends ArrayAdapter<String> {
        ...
        private ColorStateList createItemSelectedColorStateList() {
            ...
            int[] stateHovered = {R.attr.state_hovered, -16842919};
            int[] stateSelected = {R.attr.state_selected, -16842919};
