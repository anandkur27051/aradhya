    ...
    */
    ...
    private static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence $this$findAnyOf, Collection<String> collection, int startIndex, boolean ignoreCase, boolean last) {
        ...
        if (!ignoreCase && collection.size() == 1) {
            ...
            return TuplesKt.m137to(Integer.valueOf(index), string);
        }
        if (!last) {
            ...
            if ((step > 0 && index2 <= last2) || (step < 0 && last2 <= index2)) {
                ...
                while (true) {
                    ...
                    if (matchingString == null) {
                        ...
                        return TuplesKt.m137to(Integer.valueOf(index3), matchingString);
                    }
                }
            }
        } else {
            ...
            if ((step2 > 0 && index4 <= last3) || (step2 < 0 && last3 <= index4)) {
                ...
                while (true) {
                    ...
                    if (matchingString2 == null) {
                        ...
                        return TuplesKt.m137to(Integer.valueOf(index5), matchingString2);
                    }
                }
            }
        }
    ...
    public static final Pair rangesDelimitedBy$lambda$14$StringsKt__StringsKt(char[] $delimiters, boolean $ignoreCase, CharSequence DelimitedRangesSequence, int currentIndex) {
        ...
        return TuplesKt.m137to(Integer.valueOf(it), 1);
    }
    ...
    public static final Pair rangesDelimitedBy$lambda$16$StringsKt__StringsKt(List $delimitersList, boolean $ignoreCase, CharSequence DelimitedRangesSequence, int currentIndex) {
        ...
        if (it != null) {
            return TuplesKt.m137to(it.getFirst(), Integer.valueOf(it.getSecond().length()));
        }
        return null;
    }
