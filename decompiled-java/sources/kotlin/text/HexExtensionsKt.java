...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long formatLength) {
        ...
        if (!z) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m407toStringimpl(ULong.m361constructorimpl(formatLength))));
        }
