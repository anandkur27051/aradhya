...
public class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Unit copyToRecursively$lambda$6$PathsKt__PathRecursiveFunctionsKt(final ArrayList $stack, final Function3 $copyAction, final Path $this_copyToRecursively, final Path $target, final Path $normalizedTarget, final Function3 $onError, FileVisitorBuilder visitFileTree) {
        ...
        visitFileTree.onPreVisitDirectory(new Function2() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda3
            ...
            public final Object invoke(Object obj, Object obj2) {
                FileVisitResult m150x672c94f7;
                m150x672c94f7 = PathsKt__PathRecursiveFunctionsKt.m150x672c94f7($stack, $copyAction, $this_copyToRecursively, $target, $normalizedTarget, $onError, (Path) obj, (BasicFileAttributes) obj2);
                return m150x672c94f7;
            }
        });
        ...
        visitFileTree.onPostVisitDirectory(new Function2() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                FileVisitResult m151xce0554b8;
                m151xce0554b8 = PathsKt__PathRecursiveFunctionsKt.m151xce0554b8($stack, $onError, $this_copyToRecursively, $target, $normalizedTarget, (Path) obj, (IOException) obj2);
                return m151xce0554b8;
            }
        });
    ...
    public static final FileVisitResult m150x672c94f7(ArrayList $stack, Function3 $copyAction, Path $this_copyToRecursively, Path $target, Path $normalizedTarget, Function3 $onError, Path directory, BasicFileAttributes attributes) {
    ...
    public static final FileVisitResult m151xce0554b8(ArrayList $stack, Function3 $onError, Path $this_copyToRecursively, Path $target, Path $normalizedTarget, Path directory, IOException exception) {
        Intrinsics.checkNotNullParameter(directory, "directory");
