...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m355boximpl(ULong.m361constructorimpl(getMostSignificantBits())), ULong.m355boximpl(ULong.m361constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m1662toUByteArrayTcUX1vc() {
        return UByteArray.m258constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (this.mostSignificantBits != other.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m361constructorimpl(this.mostSignificantBits), ULong.m361constructorimpl(other.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m361constructorimpl(this.leastSignificantBits), ULong.m361constructorimpl(other.leastSignificantBits));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m1664fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m1663fromUByteArrayGBYM_sE(byte[] ubyteArray) {
