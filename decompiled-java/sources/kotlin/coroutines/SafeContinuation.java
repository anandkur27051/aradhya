...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public void resumeWith(Object result) {
        while (true) {
            ...
            if (cur == CoroutineSingletons.UNDECIDED) {
                if (C0119xc40028dd.m6m(RESULT, this, CoroutineSingletons.UNDECIDED, result)) {
                    return;
                }
            } else {
                ...
                if (C0119xc40028dd.m6m(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED)) {
    ...
    public final Object getOrThrow() {
        ...
        if (result == CoroutineSingletons.UNDECIDED) {
            if (C0119xc40028dd.m6m(RESULT, this, CoroutineSingletons.UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
